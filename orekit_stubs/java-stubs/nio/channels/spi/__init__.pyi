...
class AsynchronousChannelProvider:
    @typing.overload
    def openAsynchronousChannelGroup(self, int: int, threadFactory: typing.Union[java.util.concurrent.ThreadFactory, typing.Callable]) -> java.nio.channels.AsynchronousChannelGroup: ...
    @typing.overload
