...
class SelectorProvider:
    ...
    @typing.overload
    def openServerSocketChannel(self, protocolFamily: java.net.ProtocolFamily) -> java.nio.channels.ServerSocketChannel: ...
    @typing.overload
    def openSocketChannel(self) -> java.nio.channels.SocketChannel: ...
    @typing.overload
    def openSocketChannel(self, protocolFamily: java.net.ProtocolFamily) -> java.nio.channels.SocketChannel: ...
    @staticmethod
