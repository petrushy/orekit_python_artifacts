...
class ByteBuffer(Buffer, java.lang.Comparable['ByteBuffer']):
    ...
    @typing.overload
    def get(self, int: int, byteArray: typing.List[int]) -> 'ByteBuffer': ...
    @typing.overload
    def get(self, int: int, byteArray: typing.List[int], int2: int, int3: int) -> 'ByteBuffer': ...
    @typing.overload
    ...
    @typing.overload
    def put(self, int: int, byteArray: typing.List[int]) -> 'ByteBuffer': ...
    @typing.overload
    def put(self, int: int, byteArray: typing.List[int], int2: int, int3: int) -> 'ByteBuffer': ...
    @typing.overload
...
class CharBuffer(Buffer, java.lang.Comparable['CharBuffer'], java.lang.Appendable, java.lang.CharSequence, java.lang.Readable):
    ...
    @typing.overload
    def get(self, int: int, charArray: typing.List[str]) -> 'CharBuffer': ...
    @typing.overload
    def get(self, int: int, charArray: typing.List[str], int2: int, int3: int) -> 'CharBuffer': ...
    def hasArray(self) -> bool: ...
    def hashCode(self) -> int: ...
    def isDirect(self) -> bool: ...
    ...
    @typing.overload
    def put(self, int: int, charArray: typing.List[str]) -> 'CharBuffer': ...
    @typing.overload
    def put(self, int: int, charArray: typing.List[str], int2: int, int3: int) -> 'CharBuffer': ...
    @typing.overload
...
class DoubleBuffer(Buffer, java.lang.Comparable['DoubleBuffer']):
    ...
    @typing.overload
    def get(self, int: int, doubleArray: typing.List[float]) -> 'DoubleBuffer': ...
    @typing.overload
    def get(self, int: int, doubleArray: typing.List[float], int2: int, int3: int) -> 'DoubleBuffer': ...
    def hasArray(self) -> bool: ...
    def hashCode(self) -> int: ...
    def isDirect(self) -> bool: ...
    @typing.overload
    ...
    @typing.overload
    def put(self, int: int, doubleArray: typing.List[float]) -> 'DoubleBuffer': ...
    @typing.overload
    def put(self, int: int, doubleArray: typing.List[float], int2: int, int3: int) -> 'DoubleBuffer': ...
    @typing.overload
...
class FloatBuffer(Buffer, java.lang.Comparable['FloatBuffer']):
    ...
    @typing.overload
    def get(self, int: int, floatArray: typing.List[float]) -> 'FloatBuffer': ...
    @typing.overload
    def get(self, int: int, floatArray: typing.List[float], int2: int, int3: int) -> 'FloatBuffer': ...
    def hasArray(self) -> bool: ...
    def hashCode(self) -> int: ...
    def isDirect(self) -> bool: ...
    @typing.overload
    ...
    @typing.overload
    def put(self, int: int, floatArray: typing.List[float]) -> 'FloatBuffer': ...
    @typing.overload
    def put(self, int: int, floatArray: typing.List[float], int2: int, int3: int) -> 'FloatBuffer': ...
    @typing.overload
...
class IntBuffer(Buffer, java.lang.Comparable['IntBuffer']):
    ...
    def get(self, int: int) -> int: ...
    @typing.overload
    def get(self, int: int, intArray: typing.List[int]) -> 'IntBuffer': ...
    @typing.overload
    def get(self, int: int, intArray: typing.List[int], int3: int, int4: int) -> 'IntBuffer': ...
    @typing.overload
    ...
    @typing.overload
    def put(self, int: int, intArray: typing.List[int]) -> 'IntBuffer': ...
    @typing.overload
    def put(self, int: int, intArray: typing.List[int], int3: int, int4: int) -> 'IntBuffer': ...
    @typing.overload
...
class LongBuffer(Buffer, java.lang.Comparable['LongBuffer']):
    ...
    def get(self, int: int) -> int: ...
    @typing.overload
    def get(self, int: int, longArray: typing.List[int]) -> 'LongBuffer': ...
    @typing.overload
    def get(self, int: int, longArray: typing.List[int], int2: int, int3: int) -> 'LongBuffer': ...
    @typing.overload
    ...
    @typing.overload
    def put(self, int: int, longArray: typing.List[int]) -> 'LongBuffer': ...
    @typing.overload
    def put(self, int: int, longArray: typing.List[int], int2: int, int3: int) -> 'LongBuffer': ...
    @typing.overload
...
class ShortBuffer(Buffer, java.lang.Comparable['ShortBuffer']):
    ...
    def get(self, int: int) -> int: ...
    @typing.overload
    def get(self, int: int, shortArray: typing.List[int]) -> 'ShortBuffer': ...
    @typing.overload
    def get(self, int: int, shortArray: typing.List[int], int2: int, int3: int) -> 'ShortBuffer': ...
    @typing.overload
    ...
    @typing.overload
    def put(self, int: int, shortArray: typing.List[int]) -> 'ShortBuffer': ...
    @typing.overload
    def put(self, int: int, shortArray: typing.List[int], int2: int, int3: int) -> 'ShortBuffer': ...
    @typing.overload
