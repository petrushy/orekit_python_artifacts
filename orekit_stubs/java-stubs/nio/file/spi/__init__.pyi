...
class FileSystemProvider:
    ...
    def exists(self, path: typing.Union[java.nio.file.Path, jpype.protocol.SupportsPath], linkOptionArray: typing.List[java.nio.file.LinkOption]) -> bool: ...
    ...
    def readAttributesIfExists(self, path: typing.Union[java.nio.file.Path, jpype.protocol.SupportsPath], class_: typing.Type[_readAttributesIfExists__A], linkOptionArray: typing.List[java.nio.file.LinkOption]) -> _readAttributesIfExists__A: ...
