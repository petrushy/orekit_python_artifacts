...
class AWTEventMulticaster(java.awt.event.ComponentListener, java.awt.event.ContainerListener, java.awt.event.FocusListener, java.awt.event.KeyListener, java.awt.event.MouseListener, java.awt.event.MouseMotionListener, java.awt.event.WindowListener, java.awt.event.WindowFocusListener, java.awt.event.WindowStateListener, java.awt.event.ActionListener, java.awt.event.ItemListener, java.awt.event.AdjustmentListener, java.awt.event.TextListener, java.awt.event.InputMethodListener, java.awt.event.HierarchyListener, java.awt.event.HierarchyBoundsListener, java.awt.event.MouseWheelListener):
    ...
    @typing.overload
    @staticmethod
    def add(actionListener: typing.Union[java.awt.event.ActionListener, typing.Callable], actionListener2: typing.Union[java.awt.event.ActionListener, typing.Callable]) -> java.awt.event.ActionListener: ...
    @typing.overload
    @staticmethod
    def add(adjustmentListener: typing.Union[java.awt.event.AdjustmentListener, typing.Callable], adjustmentListener2: typing.Union[java.awt.event.AdjustmentListener, typing.Callable]) -> java.awt.event.AdjustmentListener: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def add(hierarchyListener: typing.Union[java.awt.event.HierarchyListener, typing.Callable], hierarchyListener2: typing.Union[java.awt.event.HierarchyListener, typing.Callable]) -> java.awt.event.HierarchyListener: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def add(itemListener: typing.Union[java.awt.event.ItemListener, typing.Callable], itemListener2: typing.Union[java.awt.event.ItemListener, typing.Callable]) -> java.awt.event.ItemListener: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def add(mouseWheelListener: typing.Union[java.awt.event.MouseWheelListener, typing.Callable], mouseWheelListener2: typing.Union[java.awt.event.MouseWheelListener, typing.Callable]) -> java.awt.event.MouseWheelListener: ...
    @typing.overload
    @staticmethod
    def add(textListener: typing.Union[java.awt.event.TextListener, typing.Callable], textListener2: typing.Union[java.awt.event.TextListener, typing.Callable]) -> java.awt.event.TextListener: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def add(windowStateListener: typing.Union[java.awt.event.WindowStateListener, typing.Callable], windowStateListener2: typing.Union[java.awt.event.WindowStateListener, typing.Callable]) -> java.awt.event.WindowStateListener: ...
    ...
    @staticmethod
    def getListeners(eventListener: java.util.EventListener, class_: typing.Type[_getListeners__T]) -> typing.MutableSequence[_getListeners__T]: ...
    ...
    @typing.overload
    @staticmethod
    def remove(actionListener: typing.Union[java.awt.event.ActionListener, typing.Callable], actionListener2: typing.Union[java.awt.event.ActionListener, typing.Callable]) -> java.awt.event.ActionListener: ...
    @typing.overload
    @staticmethod
    def remove(adjustmentListener: typing.Union[java.awt.event.AdjustmentListener, typing.Callable], adjustmentListener2: typing.Union[java.awt.event.AdjustmentListener, typing.Callable]) -> java.awt.event.AdjustmentListener: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def remove(hierarchyListener: typing.Union[java.awt.event.HierarchyListener, typing.Callable], hierarchyListener2: typing.Union[java.awt.event.HierarchyListener, typing.Callable]) -> java.awt.event.HierarchyListener: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def remove(itemListener: typing.Union[java.awt.event.ItemListener, typing.Callable], itemListener2: typing.Union[java.awt.event.ItemListener, typing.Callable]) -> java.awt.event.ItemListener: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def remove(mouseWheelListener: typing.Union[java.awt.event.MouseWheelListener, typing.Callable], mouseWheelListener2: typing.Union[java.awt.event.MouseWheelListener, typing.Callable]) -> java.awt.event.MouseWheelListener: ...
    @typing.overload
    @staticmethod
    def remove(textListener: typing.Union[java.awt.event.TextListener, typing.Callable], textListener2: typing.Union[java.awt.event.TextListener, typing.Callable]) -> java.awt.event.TextListener: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def remove(windowStateListener: typing.Union[java.awt.event.WindowStateListener, typing.Callable], windowStateListener2: typing.Union[java.awt.event.WindowStateListener, typing.Callable]) -> java.awt.event.WindowStateListener: ...
...
class Adjustable:
    ...
    def addAdjustmentListener(self, adjustmentListener: typing.Union[java.awt.event.AdjustmentListener, typing.Callable]) -> None: ...
    ...
    def removeAdjustmentListener(self, adjustmentListener: typing.Union[java.awt.event.AdjustmentListener, typing.Callable]) -> None: ...
...
class Desktop:
    ...
    class Action(java.lang.Enum['Desktop.Action']):
        ...
        @staticmethod
        def values() -> typing.MutableSequence['Desktop.Action']: ...
...
class Font(java.io.Serializable):
    ...
    @typing.overload
    def canDisplayUpTo(self, charArray: typing.Union[typing.List[str], jpype.JArray], int: int, int2: int) -> int: ...
    @typing.overload
    ...
    @typing.overload
    @staticmethod
    def createFonts(file: typing.Union[java.io.File, jpype.protocol.SupportsPath]) -> typing.MutableSequence['Font']: ...
    @typing.overload
    @staticmethod
    def createFonts(inputStream: java.io.InputStream) -> typing.MutableSequence['Font']: ...
    @typing.overload
    def createGlyphVector(self, fontRenderContext: java.awt.font.FontRenderContext, charArray: typing.Union[typing.List[str], jpype.JArray]) -> java.awt.font.GlyphVector: ...
    @typing.overload
    def createGlyphVector(self, fontRenderContext: java.awt.font.FontRenderContext, intArray: typing.Union[typing.List[int], jpype.JArray]) -> java.awt.font.GlyphVector: ...
    @typing.overload
    ...
    def getAvailableAttributes(self) -> typing.MutableSequence[java.text.AttributedCharacterIterator.Attribute]: ...
    ...
    @typing.overload
    def getLineMetrics(self, charArray: typing.Union[typing.List[str], jpype.JArray], int: int, int2: int, fontRenderContext: java.awt.font.FontRenderContext) -> java.awt.font.LineMetrics: ...
    @typing.overload
    ...
    @typing.overload
    def getStringBounds(self, charArray: typing.Union[typing.List[str], jpype.JArray], int: int, int2: int, fontRenderContext: java.awt.font.FontRenderContext) -> java.awt.geom.Rectangle2D: ...
    @typing.overload
    ...
    def layoutGlyphVector(self, fontRenderContext: java.awt.font.FontRenderContext, charArray: typing.Union[typing.List[str], jpype.JArray], int: int, int2: int, int3: int) -> java.awt.font.GlyphVector: ...
    @staticmethod
    def textRequiresLayout(charArray: typing.Union[typing.List[str], jpype.JArray], int: int, int2: int) -> bool: ...
    def toString(self) -> str: ...
...
class FontMetrics(java.io.Serializable):
    def bytesWidth(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int, int2: int) -> int: ...
    @typing.overload
    def charWidth(self, char: str) -> int: ...
    @typing.overload
    def charWidth(self, int: int) -> int: ...
    def charsWidth(self, charArray: typing.Union[typing.List[str], jpype.JArray], int: int, int2: int) -> int: ...
    ...
    @typing.overload
    def getLineMetrics(self, charArray: typing.Union[typing.List[str], jpype.JArray], int: int, int2: int, graphics: 'Graphics') -> java.awt.font.LineMetrics: ...
    @typing.overload
    ...
    @typing.overload
    def getStringBounds(self, charArray: typing.Union[typing.List[str], jpype.JArray], int: int, int2: int, graphics: 'Graphics') -> java.awt.geom.Rectangle2D: ...
    @typing.overload
    ...
    def getWidths(self) -> typing.MutableSequence[int]: ...
    def hasUniformLineMetrics(self) -> bool: ...
...
class Graphics:
    ...
    def drawBytes(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int, int2: int, int3: int, int4: int) -> None: ...
    def drawChars(self, charArray: typing.Union[typing.List[str], jpype.JArray], int: int, int2: int, int3: int, int4: int) -> None: ...
    @typing.overload
    def drawImage(self, image: 'Image', int: int, int2: int, int3: int, int4: int, int5: int, int6: int, int7: int, int8: int, color: 'Color', imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> bool: ...
    @typing.overload
    def drawImage(self, image: 'Image', int: int, int2: int, int3: int, int4: int, int5: int, int6: int, int7: int, int8: int, imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> bool: ...
    @typing.overload
    def drawImage(self, image: 'Image', int: int, int2: int, int3: int, int4: int, color: 'Color', imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> bool: ...
    @typing.overload
    def drawImage(self, image: 'Image', int: int, int2: int, int3: int, int4: int, imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> bool: ...
    @typing.overload
    def drawImage(self, image: 'Image', int: int, int2: int, color: 'Color', imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> bool: ...
    @typing.overload
    def drawImage(self, image: 'Image', int: int, int2: int, imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> bool: ...
    def drawLine(self, int: int, int2: int, int3: int, int4: int) -> None: ...
    def drawOval(self, int: int, int2: int, int3: int, int4: int) -> None: ...
    @typing.overload
    def drawPolygon(self, intArray: typing.Union[typing.List[int], jpype.JArray], intArray2: typing.Union[typing.List[int], jpype.JArray], int3: int) -> None: ...
    @typing.overload
    def drawPolygon(self, polygon: 'Polygon') -> None: ...
    def drawPolyline(self, intArray: typing.Union[typing.List[int], jpype.JArray], intArray2: typing.Union[typing.List[int], jpype.JArray], int3: int) -> None: ...
    ...
    @typing.overload
    def fillPolygon(self, intArray: typing.Union[typing.List[int], jpype.JArray], intArray2: typing.Union[typing.List[int], jpype.JArray], int3: int) -> None: ...
    @typing.overload
...
class GraphicsConfigTemplate(java.io.Serializable):
    ...
    def __init__(self): ...
    def getBestConfiguration(self, graphicsConfigurationArray: typing.Union[typing.List['GraphicsConfiguration'], jpype.JArray]) -> 'GraphicsConfiguration': ...
...
class GraphicsDevice:
    ...
    def getConfigurations(self) -> typing.MutableSequence[GraphicsConfiguration]: ...
    def getDefaultConfiguration(self) -> GraphicsConfiguration: ...
    def getDisplayMode(self) -> DisplayMode: ...
    def getDisplayModes(self) -> typing.MutableSequence[DisplayMode]: ...
    ...
    class WindowTranslucency(java.lang.Enum['GraphicsDevice.WindowTranslucency']):
        ...
        def valueOf(class_: typing.Type[_valueOf_1__T], string: str) -> _valueOf_1__T: ...
        @staticmethod
        def values() -> typing.MutableSequence['GraphicsDevice.WindowTranslucency']: ...

class GraphicsEnvironment:
    def createGraphics(self, bufferedImage: java.awt.image.BufferedImage) -> 'Graphics2D': ...
    def getAllFonts(self) -> typing.MutableSequence[Font]: ...
    @typing.overload
    def getAvailableFontFamilyNames(self) -> typing.MutableSequence[str]: ...
    @typing.overload
    def getAvailableFontFamilyNames(self, locale: java.util.Locale) -> typing.MutableSequence[str]: ...
    ...
    def getScreenDevices(self) -> typing.MutableSequence[GraphicsDevice]: ...
    @staticmethod
    def isHeadless() -> bool: ...
...
class Image:
    ...
    def getHeight(self, imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> int: ...
    def getProperty(self, string: str, imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> typing.Any: ...
    def getScaledInstance(self, int: int, int2: int, int3: int) -> 'Image': ...
    def getSource(self) -> java.awt.image.ImageProducer: ...
    def getWidth(self, imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> int: ...
...
class ItemSelectable:
    def addItemListener(self, itemListener: typing.Union[java.awt.event.ItemListener, typing.Callable]) -> None: ...
    def getSelectedObjects(self) -> typing.MutableSequence[typing.Any]: ...
    def removeItemListener(self, itemListener: typing.Union[java.awt.event.ItemListener, typing.Callable]) -> None: ...
...
class MediaTracker(java.io.Serializable):
    ...
    def getErrorsAny(self) -> typing.MutableSequence[typing.Any]: ...
    def getErrorsID(self, int: int) -> typing.MutableSequence[typing.Any]: ...
...
class SystemTray:
    ...
    def getPropertyChangeListeners(self, string: str) -> typing.MutableSequence[java.beans.PropertyChangeListener]: ...
    @staticmethod
    def getSystemTray() -> 'SystemTray': ...
    def getTrayIconSize(self) -> Dimension: ...
    def getTrayIcons(self) -> typing.MutableSequence['TrayIcon']: ...
    @staticmethod
...
class Taskbar:
    ...
    class Feature(java.lang.Enum['Taskbar.Feature']):
        ...
        def valueOf(class_: typing.Type[_valueOf_1__T], string: str) -> _valueOf_1__T: ...
        @staticmethod
        def values() -> typing.MutableSequence['Taskbar.Feature']: ...
...
class Toolkit:
    ...
    def beep(self) -> None: ...
    def checkImage(self, image: Image, int: int, int2: int, imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> int: ...
    ...
    def createDragGestureRecognizer(self, class_: typing.Type[_createDragGestureRecognizer__T], dragSource: java.awt.dnd.DragSource, component: 'Component', int: int, dragGestureListener: typing.Union[java.awt.dnd.DragGestureListener, typing.Callable]) -> _createDragGestureRecognizer__T: ...
    @typing.overload
    def createImage(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int, int2: int) -> Image: ...
    @typing.overload
    ...
    @typing.overload
    def createImage(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> Image: ...
    @typing.overload
    def getAWTEventListeners(self) -> typing.MutableSequence[java.awt.event.AWTEventListener]: ...
    @typing.overload
    def getAWTEventListeners(self, long: int) -> typing.MutableSequence[java.awt.event.AWTEventListener]: ...
    ...
    def getFontList(self) -> typing.MutableSequence[str]: ...
    def getFontMetrics(self, font: Font) -> FontMetrics: ...
    @typing.overload
    ...
    @typing.overload
    def getPropertyChangeListeners(self) -> typing.MutableSequence[java.beans.PropertyChangeListener]: ...
    @typing.overload
    def getPropertyChangeListeners(self, string: str) -> typing.MutableSequence[java.beans.PropertyChangeListener]: ...
    ...
    def prepareImage(self, image: Image, int: int, int2: int, imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> bool: ...
    def removeAWTEventListener(self, aWTEventListener: typing.Union[java.awt.event.AWTEventListener, typing.Callable]) -> None: ...
    def removePropertyChangeListener(self, string: str, propertyChangeListener: typing.Union[java.beans.PropertyChangeListener, typing.Callable]) -> None: ...
...
class TrayIcon:
    ...
    def addActionListener(self, actionListener: typing.Union[java.awt.event.ActionListener, typing.Callable]) -> None: ...
    ...
    def getActionListeners(self) -> typing.MutableSequence[java.awt.event.ActionListener]: ...
    def getImage(self) -> Image: ...
    def getMouseListeners(self) -> typing.MutableSequence[java.awt.event.MouseListener]: ...
    def getMouseMotionListeners(self) -> typing.MutableSequence[java.awt.event.MouseMotionListener]: ...
    def getPopupMenu(self) -> 'PopupMenu': ...
    def getSize(self) -> Dimension: ...
    def getToolTip(self) -> str: ...
    def isImageAutoSize(self) -> bool: ...
    def removeActionListener(self, actionListener: typing.Union[java.awt.event.ActionListener, typing.Callable]) -> None: ...
    ...
    class MessageType(java.lang.Enum['TrayIcon.MessageType']):
        ...
        def valueOf(class_: typing.Type[_valueOf_1__T], string: str) -> _valueOf_1__T: ...
        @staticmethod
        def values() -> typing.MutableSequence['TrayIcon.MessageType']: ...
...
class BasicStroke(Stroke):
    ...
    @typing.overload
    def __init__(self, float: float, int: int, int2: int, float2: float, floatArray: typing.Union[typing.List[float], jpype.JArray], float4: float): ...
    def createStrokedShape(self, shape: Shape) -> Shape: ...
    def equals(self, object: typing.Any) -> bool: ...
    def getDashArray(self) -> typing.MutableSequence[float]: ...
...
class Component(java.awt.image.ImageObserver, MenuContainer, java.io.Serializable):
    ...
    def addHierarchyListener(self, hierarchyListener: typing.Union[java.awt.event.HierarchyListener, typing.Callable]) -> None: ...
    ...
    def addMouseListener(self, mouseListener: java.awt.event.MouseListener) -> None: ...
    def addMouseMotionListener(self, mouseMotionListener: java.awt.event.MouseMotionListener) -> None: ...
    def addMouseWheelListener(self, mouseWheelListener: typing.Union[java.awt.event.MouseWheelListener, typing.Callable]) -> None: ...
    ...
    def checkImage(self, image: Image, int: int, int2: int, imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> int: ...
    @typing.overload
    def checkImage(self, image: Image, imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> int: ...
    @typing.overload
    ...
    def getComponentListeners(self) -> typing.MutableSequence[java.awt.event.ComponentListener]: ...
    ...
    def getFocusListeners(self) -> typing.MutableSequence[java.awt.event.FocusListener]: ...
    ...
    def getHeight(self) -> int: ...
    def getHierarchyBoundsListeners(self) -> typing.MutableSequence[java.awt.event.HierarchyBoundsListener]: ...
    def getHierarchyListeners(self) -> typing.MutableSequence[java.awt.event.HierarchyListener]: ...
    def getIgnoreRepaint(self) -> bool: ...
    def getInputContext(self) -> java.awt.im.InputContext: ...
    def getInputMethodListeners(self) -> typing.MutableSequence[java.awt.event.InputMethodListener]: ...
    def getInputMethodRequests(self) -> java.awt.im.InputMethodRequests: ...
    def getKeyListeners(self) -> typing.MutableSequence[java.awt.event.KeyListener]: ...
    _getListeners__T = typing.TypeVar('_getListeners__T', bound=java.util.EventListener)  # <T>
    ...
    def getMouseWheelListeners(self) -> typing.MutableSequence[java.awt.event.MouseWheelListener]: ...
    def getName(self) -> str: ...
    ...
    def prepareImage(self, image: Image, int: int, int2: int, imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> bool: ...
    @typing.overload
    def prepareImage(self, image: Image, imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> bool: ...
    def printAll(self, graphics: Graphics) -> None: ...
    def print_(self, graphics: Graphics) -> None: ...
    def remove(self, menuComponent: MenuComponent) -> None: ...
    ...
    def removeHierarchyListener(self, hierarchyListener: typing.Union[java.awt.event.HierarchyListener, typing.Callable]) -> None: ...
    ...
    def removeMouseListener(self, mouseListener: java.awt.event.MouseListener) -> None: ...
    def removeMouseMotionListener(self, mouseMotionListener: java.awt.event.MouseMotionListener) -> None: ...
    def removeMouseWheelListener(self, mouseWheelListener: typing.Union[java.awt.event.MouseWheelListener, typing.Callable]) -> None: ...
    def removeNotify(self) -> None: ...
    @typing.overload
    ...
    class BaselineResizeBehavior(java.lang.Enum['Component.BaselineResizeBehavior']):
        ...
        def valueOf(class_: typing.Type[_valueOf_1__T], string: str) -> _valueOf_1__T: ...
        @staticmethod
        def values() -> typing.MutableSequence['Component.BaselineResizeBehavior']: ...
...
class Graphics2D(Graphics):
    ...
    def drawImage(self, image: Image, int: int, int2: int, imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> bool: ...
    @typing.overload
    def drawImage(self, image: Image, affineTransform: java.awt.geom.AffineTransform, imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> bool: ...
    @typing.overload
    ...
    def setBackground(self, color: 'Color') -> None: ...
    def setComposite(self, composite: typing.Union[Composite, typing.Callable]) -> None: ...
    ...
    def setStroke(self, stroke: typing.Union[Stroke, typing.Callable]) -> None: ...
...
class KeyboardFocusManager(KeyEventDispatcher, KeyEventPostProcessor):
    ...
    def addPropertyChangeListener(self, string: str, propertyChangeListener: typing.Union[java.beans.PropertyChangeListener, typing.Callable]) -> None: ...
    @typing.overload
    def addVetoableChangeListener(self, vetoableChangeListener: typing.Union[java.beans.VetoableChangeListener, typing.Callable]) -> None: ...
    @typing.overload
    def addVetoableChangeListener(self, string: str, vetoableChangeListener: typing.Union[java.beans.VetoableChangeListener, typing.Callable]) -> None: ...
    ...
    def getPropertyChangeListeners(self, string: str) -> typing.MutableSequence[java.beans.PropertyChangeListener]: ...
    @typing.overload
    def getVetoableChangeListeners(self) -> typing.MutableSequence[java.beans.VetoableChangeListener]: ...
    @typing.overload
    def getVetoableChangeListeners(self, string: str) -> typing.MutableSequence[java.beans.VetoableChangeListener]: ...
    def postProcessKeyEvent(self, keyEvent: java.awt.event.KeyEvent) -> bool: ...
    ...
    def removePropertyChangeListener(self, string: str, propertyChangeListener: typing.Union[java.beans.PropertyChangeListener, typing.Callable]) -> None: ...
    @typing.overload
    def removeVetoableChangeListener(self, vetoableChangeListener: typing.Union[java.beans.VetoableChangeListener, typing.Callable]) -> None: ...
    @typing.overload
    def removeVetoableChangeListener(self, string: str, vetoableChangeListener: typing.Union[java.beans.VetoableChangeListener, typing.Callable]) -> None: ...
    @staticmethod
...
class Polygon(Shape, java.io.Serializable):
    npoints: int = ...
    xpoints: typing.MutableSequence[int] = ...
    ypoints: typing.MutableSequence[int] = ...
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, intArray: typing.Union[typing.List[int], jpype.JArray], intArray2: typing.Union[typing.List[int], jpype.JArray], int3: int): ...
...
class ScrollPaneAdjustable(Adjustable, java.io.Serializable):
    def addAdjustmentListener(self, adjustmentListener: typing.Union[java.awt.event.AdjustmentListener, typing.Callable]) -> None: ...
    def getAdjustmentListeners(self) -> typing.MutableSequence[java.awt.event.AdjustmentListener]: ...
    def getBlockIncrement(self) -> int: ...
    def getMaximum(self) -> int: ...
    def getMinimum(self) -> int: ...
    def getOrientation(self) -> int: ...
...
class Checkbox(Component, ItemSelectable, javax.accessibility.Accessible):
    ...
    def getItemListeners(self) -> typing.MutableSequence[java.awt.event.ItemListener]: ...
    def getLabel(self) -> str: ...
    _getListeners__T = typing.TypeVar('_getListeners__T', bound=java.util.EventListener)  # <T>
    def getListeners(self, class_: typing.Type[_getListeners__T]) -> typing.MutableSequence[_getListeners__T]: ...
    def getSelectedObjects(self) -> typing.MutableSequence[typing.Any]: ...
...
class Color(Paint, java.io.Serializable):
    ...
    def __init__(self, int: int, int2: int, int3: int, int4: int): ...
    @typing.overload
    def __init__(self, colorSpace: java.awt.color.ColorSpace, floatArray: typing.Union[typing.List[float], jpype.JArray], float2: float): ...
    @staticmethod
    def HSBtoRGB(float: float, float2: float, float3: float) -> int: ...
    @staticmethod
    def RGBtoHSB(int: int, int2: int, int3: int, floatArray: typing.Union[typing.List[float], jpype.JArray]) -> typing.MutableSequence[float]: ...
    ...
    @typing.overload
    def getColorComponents(self, floatArray: typing.Union[typing.List[float], jpype.JArray]) -> typing.MutableSequence[float]: ...
    @typing.overload
    def getColorComponents(self, colorSpace: java.awt.color.ColorSpace, floatArray: typing.Union[typing.List[float], jpype.JArray]) -> typing.MutableSequence[float]: ...
    ...
    @typing.overload
    def getComponents(self, colorSpace: java.awt.color.ColorSpace, floatArray: typing.Union[typing.List[float], jpype.JArray]) -> typing.MutableSequence[float]: ...
    def getGreen(self) -> int: ...
    @staticmethod
    def getHSBColor(float: float, float2: float, float3: float) -> 'Color': ...
    def getRGB(self) -> int: ...
    def getRGBColorComponents(self, floatArray: typing.Union[typing.List[float], jpype.JArray]) -> typing.MutableSequence[float]: ...
    def getRGBComponents(self, floatArray: typing.Union[typing.List[float], jpype.JArray]) -> typing.MutableSequence[float]: ...
    def getRed(self) -> int: ...
    def getTransparency(self) -> int: ...
    def hashCode(self) -> int: ...
    def toString(self) -> str: ...
...
class Container(Component):
    ...
    def getComponents(self) -> typing.MutableSequence[Component]: ...
    def getContainerListeners(self) -> typing.MutableSequence[java.awt.event.ContainerListener]: ...
    def getFocusTraversalKeys(self, int: int) -> java.util.Set[AWTKeyStroke]: ...
...
class GridBagLayout(LayoutManager2, java.io.Serializable):
    columnWidths: typing.MutableSequence[int] = ...
    rowHeights: typing.MutableSequence[int] = ...
    columnWeights: typing.MutableSequence[float] = ...
    rowWeights: typing.MutableSequence[float] = ...
    def __init__(self): ...
    @typing.overload
    def addLayoutComponent(self, component: Component, object: typing.Any) -> None: ...
    @typing.overload
    ...
    def getLayoutAlignmentX(self, container: Container) -> float: ...
    def getLayoutAlignmentY(self, container: Container) -> float: ...
    def getLayoutDimensions(self) -> typing.MutableSequence[typing.MutableSequence[int]]: ...
    def getLayoutOrigin(self) -> Point: ...
    def getLayoutWeights(self) -> typing.MutableSequence[typing.MutableSequence[float]]: ...
    def invalidateLayout(self, container: Container) -> None: ...
    def layoutContainer(self, container: Container) -> None: ...
...
class List(Component, ItemSelectable, javax.accessibility.Accessible):
    ...
    def getItemCount(self) -> int: ...
    def getItemListeners(self) -> typing.MutableSequence[java.awt.event.ItemListener]: ...
    def getItems(self) -> typing.MutableSequence[str]: ...
    _getListeners__T = typing.TypeVar('_getListeners__T', bound=java.util.EventListener)  # <T>
    def getListeners(self, class_: typing.Type[_getListeners__T]) -> typing.MutableSequence[_getListeners__T]: ...
    @typing.overload
    def getMinimumSize(self) -> Dimension: ...
    ...
    def getSelectedItem(self) -> str: ...
    def getSelectedItems(self) -> typing.MutableSequence[str]: ...
    def getSelectedObjects(self) -> typing.MutableSequence[typing.Any]: ...
...
class MultipleGradientPaint(Paint):
    ...
    def getColors(self) -> typing.MutableSequence[Color]: ...
    def getCycleMethod(self) -> 'MultipleGradientPaint.CycleMethod': ...
    def getFractions(self) -> typing.MutableSequence[float]: ...
    def getTransform(self) -> java.awt.geom.AffineTransform: ...
    def getTransparency(self) -> int: ...
    class ColorSpaceType(java.lang.Enum['MultipleGradientPaint.ColorSpaceType']):
        ...
        def valueOf(class_: typing.Type[_valueOf_1__T], string: str) -> _valueOf_1__T: ...
        @staticmethod
        def values() -> typing.MutableSequence['MultipleGradientPaint.ColorSpaceType']: ...
    class CycleMethod(java.lang.Enum['MultipleGradientPaint.CycleMethod']):
        ...
        def valueOf(class_: typing.Type[_valueOf_1__T], string: str) -> _valueOf_1__T: ...
        @staticmethod
        def values() -> typing.MutableSequence['MultipleGradientPaint.CycleMethod']: ...
...
class TextComponent(Component, javax.accessibility.Accessible):
    def addNotify(self) -> None: ...
    def addTextListener(self, textListener: typing.Union[java.awt.event.TextListener, typing.Callable]) -> None: ...
    def enableInputMethods(self, boolean: bool) -> None: ...
    def getAccessibleContext(self) -> javax.accessibility.AccessibleContext: ...
    def getBackground(self) -> Color: ...
    ...
    def getText(self) -> str: ...
    def getTextListeners(self) -> typing.MutableSequence[java.awt.event.TextListener]: ...
    def isEditable(self) -> bool: ...
    def removeNotify(self) -> None: ...
    def removeTextListener(self, textListener: typing.Union[java.awt.event.TextListener, typing.Callable]) -> None: ...
...
class LinearGradientPaint(MultipleGradientPaint):
    @typing.overload
    def __init__(self, float: float, float2: float, float3: float, float4: float, floatArray: typing.Union[typing.List[float], jpype.JArray], colorArray: typing.Union[typing.List[Color], jpype.JArray]): ...
    @typing.overload
    def __init__(self, float: float, float2: float, float3: float, float4: float, floatArray: typing.Union[typing.List[float], jpype.JArray], colorArray: typing.Union[typing.List[Color], jpype.JArray], cycleMethod: MultipleGradientPaint.CycleMethod): ...
    @typing.overload
    def __init__(self, point2D: java.awt.geom.Point2D, point2D2: java.awt.geom.Point2D, floatArray: typing.Union[typing.List[float], jpype.JArray], colorArray: typing.Union[typing.List[Color], jpype.JArray]): ...
    @typing.overload
    def __init__(self, point2D: java.awt.geom.Point2D, point2D2: java.awt.geom.Point2D, floatArray: typing.Union[typing.List[float], jpype.JArray], colorArray: typing.Union[typing.List[Color], jpype.JArray], cycleMethod: MultipleGradientPaint.CycleMethod): ...
    @typing.overload
    def __init__(self, point2D: java.awt.geom.Point2D, point2D2: java.awt.geom.Point2D, floatArray: typing.Union[typing.List[float], jpype.JArray], colorArray: typing.Union[typing.List[Color], jpype.JArray], cycleMethod: MultipleGradientPaint.CycleMethod, colorSpaceType: MultipleGradientPaint.ColorSpaceType, affineTransform: java.awt.geom.AffineTransform): ...
    def createContext(self, colorModel: java.awt.image.ColorModel, rectangle: Rectangle, rectangle2D: java.awt.geom.Rectangle2D, affineTransform: java.awt.geom.AffineTransform, renderingHints: RenderingHints) -> PaintContext: ...
...
class RadialGradientPaint(MultipleGradientPaint):
    @typing.overload
    def __init__(self, float: float, float2: float, float3: float, float4: float, float5: float, floatArray: typing.Union[typing.List[float], jpype.JArray], colorArray: typing.Union[typing.List[Color], jpype.JArray], cycleMethod: MultipleGradientPaint.CycleMethod): ...
    @typing.overload
    def __init__(self, float: float, float2: float, float3: float, floatArray: typing.Union[typing.List[float], jpype.JArray], colorArray: typing.Union[typing.List[Color], jpype.JArray]): ...
    @typing.overload
    def __init__(self, float: float, float2: float, float3: float, floatArray: typing.Union[typing.List[float], jpype.JArray], colorArray: typing.Union[typing.List[Color], jpype.JArray], cycleMethod: MultipleGradientPaint.CycleMethod): ...
    @typing.overload
    def __init__(self, point2D: java.awt.geom.Point2D, float: float, floatArray: typing.Union[typing.List[float], jpype.JArray], colorArray: typing.Union[typing.List[Color], jpype.JArray]): ...
    @typing.overload
    def __init__(self, point2D: java.awt.geom.Point2D, float: float, floatArray: typing.Union[typing.List[float], jpype.JArray], colorArray: typing.Union[typing.List[Color], jpype.JArray], cycleMethod: MultipleGradientPaint.CycleMethod): ...
    @typing.overload
    def __init__(self, point2D: java.awt.geom.Point2D, float: float, point2D2: java.awt.geom.Point2D, floatArray: typing.Union[typing.List[float], jpype.JArray], colorArray: typing.Union[typing.List[Color], jpype.JArray], cycleMethod: MultipleGradientPaint.CycleMethod): ...
    @typing.overload
    def __init__(self, point2D: java.awt.geom.Point2D, float: float, point2D2: java.awt.geom.Point2D, floatArray: typing.Union[typing.List[float], jpype.JArray], colorArray: typing.Union[typing.List[Color], jpype.JArray], cycleMethod: MultipleGradientPaint.CycleMethod, colorSpaceType: MultipleGradientPaint.ColorSpaceType, affineTransform: java.awt.geom.AffineTransform): ...
    @typing.overload
    def __init__(self, rectangle2D: java.awt.geom.Rectangle2D, floatArray: typing.Union[typing.List[float], jpype.JArray], colorArray: typing.Union[typing.List[Color], jpype.JArray], cycleMethod: MultipleGradientPaint.CycleMethod): ...
    def createContext(self, colorModel: java.awt.image.ColorModel, rectangle: Rectangle, rectangle2D: java.awt.geom.Rectangle2D, affineTransform: java.awt.geom.AffineTransform, renderingHints: RenderingHints) -> PaintContext: ...
...
class Window(Container, javax.accessibility.Accessible):
    ...
    def addWindowStateListener(self, windowStateListener: typing.Union[java.awt.event.WindowStateListener, typing.Callable]) -> None: ...
    @typing.overload
    ...
    def getOwnedWindows(self) -> typing.MutableSequence['Window']: ...
    def getOwner(self) -> 'Window': ...
    @staticmethod
    def getOwnerlessWindows() -> typing.MutableSequence['Window']: ...
    def getShape(self) -> Shape: ...
    def getToolkit(self) -> Toolkit: ...
    def getType(self) -> 'Window.Type': ...
    def getWarningString(self) -> str: ...
    def getWindowFocusListeners(self) -> typing.MutableSequence[java.awt.event.WindowFocusListener]: ...
    def getWindowListeners(self) -> typing.MutableSequence[java.awt.event.WindowListener]: ...
    def getWindowStateListeners(self) -> typing.MutableSequence[java.awt.event.WindowStateListener]: ...
    @staticmethod
    def getWindows() -> typing.MutableSequence['Window']: ...
    def hide(self) -> None: ...
    ...
    def removeWindowStateListener(self, windowStateListener: typing.Union[java.awt.event.WindowStateListener, typing.Callable]) -> None: ...
    def reshape(self, int: int, int2: int, int3: int, int4: int) -> None: ...
    ...
    class Type(java.lang.Enum['Window.Type']):
        ...
        def valueOf(class_: typing.Type[_valueOf_1__T], string: str) -> _valueOf_1__T: ...
        @staticmethod
        def values() -> typing.MutableSequence['Window.Type']: ...
...
class Dialog(Window):
    ...
    class ModalExclusionType(java.lang.Enum['Dialog.ModalExclusionType']):
        ...
        def valueOf(class_: typing.Type[_valueOf_1__T], string: str) -> _valueOf_1__T: ...
        @staticmethod
        def values() -> typing.MutableSequence['Dialog.ModalExclusionType']: ...
    class ModalityType(java.lang.Enum['Dialog.ModalityType']):
        ...
        def valueOf(class_: typing.Type[_valueOf_1__T], string: str) -> _valueOf_1__T: ...
        @staticmethod
        def values() -> typing.MutableSequence['Dialog.ModalityType']: ...
...
class Frame(Window, MenuContainer):
    ...
    @staticmethod
    def getFrames() -> typing.MutableSequence['Frame']: ...
    def getIconImage(self) -> Image: ...
...
class FileDialog(Dialog):
    ...
    def getFiles(self) -> typing.MutableSequence[java.io.File]: ...
...
class JobAttributes(java.lang.Cloneable):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, int: int, defaultSelectionType: 'JobAttributes.DefaultSelectionType', destinationType: 'JobAttributes.DestinationType', dialogType: 'JobAttributes.DialogType', string: str, int2: int, int3: int, multipleDocumentHandlingType: 'JobAttributes.MultipleDocumentHandlingType', intArray: typing.Union[typing.List[typing.MutableSequence[int]], jpype.JArray], string2: str, sidesType: 'JobAttributes.SidesType'): ...
    @typing.overload
    ...
    def getPageRanges(self) -> typing.MutableSequence[typing.MutableSequence[int]]: ...
    ...
    def setPageRanges(self, intArray: typing.Union[typing.List[typing.MutableSequence[int]], jpype.JArray]) -> None: ...
...
class PageAttributes(java.lang.Cloneable):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, colorType: 'PageAttributes.ColorType', mediaType: 'PageAttributes.MediaType', orientationRequestedType: 'PageAttributes.OrientationRequestedType', originType: 'PageAttributes.OriginType', printQualityType: 'PageAttributes.PrintQualityType', intArray: typing.Union[typing.List[int], jpype.JArray]): ...
    @typing.overload
    ...
    def getPrinterResolution(self) -> typing.MutableSequence[int]: ...
    def hashCode(self) -> int: ...
    ...
    @typing.overload
    def setPrinterResolution(self, intArray: typing.Union[typing.List[int], jpype.JArray]) -> None: ...
