...
class GlyphVector(java.lang.Cloneable):
    ...
    def getGlyphCharIndices(self, int: int, int2: int, intArray: typing.Union[typing.List[int], jpype.JArray]) -> typing.MutableSequence[int]: ...
    def getGlyphCode(self, int: int) -> int: ...
    def getGlyphCodes(self, int: int, int2: int, intArray: typing.Union[typing.List[int], jpype.JArray]) -> typing.MutableSequence[int]: ...
    ...
    def getGlyphPositions(self, int: int, int2: int, floatArray: typing.Union[typing.List[float], jpype.JArray]) -> typing.MutableSequence[float]: ...
...
class MultipleMaster:
    @typing.overload
    def deriveMMFont(self, floatArray: typing.Union[typing.List[float], jpype.JArray]) -> java.awt.Font: ...
    @typing.overload
    def deriveMMFont(self, floatArray: typing.Union[typing.List[float], jpype.JArray], float2: float, float3: float, float4: float, float5: float) -> java.awt.Font: ...
    def getDesignAxisDefaults(self) -> typing.MutableSequence[float]: ...
    def getDesignAxisNames(self) -> typing.MutableSequence[str]: ...
    def getDesignAxisRanges(self) -> typing.MutableSequence[float]: ...
...
class NumericShaper(java.io.Serializable):
    ...
    @typing.overload
    def shape(self, charArray: typing.Union[typing.List[str], jpype.JArray], int: int, int2: int) -> None: ...
    @typing.overload
    def shape(self, charArray: typing.Union[typing.List[str], jpype.JArray], int: int, int2: int, int3: int) -> None: ...
    @typing.overload
    def shape(self, charArray: typing.Union[typing.List[str], jpype.JArray], int: int, int2: int, range: 'NumericShaper.Range') -> None: ...
    ...
    class Range(java.lang.Enum['NumericShaper.Range']):
        ...
        @staticmethod
        def values() -> typing.MutableSequence['NumericShaper.Range']: ...
...
class OpenType:
    ...
    @typing.overload
    def getFontTable(self, int: int) -> typing.MutableSequence[int]: ...
    @typing.overload
    def getFontTable(self, int: int, int2: int, int3: int) -> typing.MutableSequence[int]: ...
    @typing.overload
    def getFontTable(self, string: str) -> typing.MutableSequence[int]: ...
    @typing.overload
    def getFontTable(self, string: str, int: int, int2: int) -> typing.MutableSequence[int]: ...
    @typing.overload
...
class TextLayout(java.lang.Cloneable):
    ...
    def getBounds(self) -> java.awt.geom.Rectangle2D: ...
    @typing.overload
    def getCaretInfo(self, textHitInfo: TextHitInfo) -> typing.MutableSequence[float]: ...
    @typing.overload
    def getCaretInfo(self, textHitInfo: TextHitInfo, rectangle2D: java.awt.geom.Rectangle2D) -> typing.MutableSequence[float]: ...
    @typing.overload
    ...
    @typing.overload
    def getCaretShapes(self, int: int) -> typing.MutableSequence[java.awt.Shape]: ...
    @typing.overload
    def getCaretShapes(self, int: int, rectangle2D: java.awt.geom.Rectangle2D) -> typing.MutableSequence[java.awt.Shape]: ...
    @typing.overload
    def getCaretShapes(self, int: int, rectangle2D: java.awt.geom.Rectangle2D, caretPolicy: 'TextLayout.CaretPolicy') -> typing.MutableSequence[java.awt.Shape]: ...
    ...
    def getLogicalRangesForVisualSelection(self, textHitInfo: TextHitInfo, textHitInfo2: TextHitInfo) -> typing.MutableSequence[int]: ...
    @typing.overload
