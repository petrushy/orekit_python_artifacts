...
class Customizer:
    def addPropertyChangeListener(self, propertyChangeListener: typing.Union['PropertyChangeListener', typing.Callable]) -> None: ...
    def removePropertyChangeListener(self, propertyChangeListener: typing.Union['PropertyChangeListener', typing.Callable]) -> None: ...
...
class Encoder:
    ...
    def setExceptionListener(self, exceptionListener: typing.Union['ExceptionListener', typing.Callable]) -> None: ...
...
class PropertyChangeSupport(java.io.Serializable):
    ...
    def addPropertyChangeListener(self, propertyChangeListener: typing.Union[PropertyChangeListener, typing.Callable]) -> None: ...
    @typing.overload
    def addPropertyChangeListener(self, string: str, propertyChangeListener: typing.Union[PropertyChangeListener, typing.Callable]) -> None: ...
    @typing.overload
    ...
    def removePropertyChangeListener(self, propertyChangeListener: typing.Union[PropertyChangeListener, typing.Callable]) -> None: ...
    @typing.overload
    def removePropertyChangeListener(self, string: str, propertyChangeListener: typing.Union[PropertyChangeListener, typing.Callable]) -> None: ...
...
class VetoableChangeSupport(java.io.Serializable):
    def __init__(self, object: typing.Any): ...
    @typing.overload
    def addVetoableChangeListener(self, vetoableChangeListener: typing.Union[VetoableChangeListener, typing.Callable]) -> None: ...
    @typing.overload
    def addVetoableChangeListener(self, string: str, vetoableChangeListener: typing.Union[VetoableChangeListener, typing.Callable]) -> None: ...
    @typing.overload
    ...
    def hasListeners(self, string: str) -> bool: ...
    @typing.overload
    def removeVetoableChangeListener(self, vetoableChangeListener: typing.Union[VetoableChangeListener, typing.Callable]) -> None: ...
    @typing.overload
    def removeVetoableChangeListener(self, string: str, vetoableChangeListener: typing.Union[VetoableChangeListener, typing.Callable]) -> None: ...
...
class XMLDecoder(java.lang.AutoCloseable):
    ...
    @typing.overload
    def __init__(self, inputStream: java.io.InputStream, object: typing.Any, exceptionListener: typing.Union[ExceptionListener, typing.Callable]): ...
    @typing.overload
    def __init__(self, inputStream: java.io.InputStream, object: typing.Any, exceptionListener: typing.Union[ExceptionListener, typing.Callable], classLoader: java.lang.ClassLoader): ...
    @typing.overload
    def __init__(self, inputSource: org.xml.sax.InputSource): ...
    def close(self) -> None: ...
    @staticmethod
    def createHandler(object: typing.Any, exceptionListener: typing.Union[ExceptionListener, typing.Callable], classLoader: java.lang.ClassLoader) -> org.xml.sax.helpers.DefaultHandler: ...
    def getExceptionListener(self) -> ExceptionListener: ...
...
class PropertyChangeListenerProxy(java.util.EventListenerProxy[PropertyChangeListener], PropertyChangeListener):
    def __init__(self, string: str, propertyChangeListener: typing.Union[PropertyChangeListener, typing.Callable]): ...
    def getPropertyName(self) -> str: ...
    def propertyChange(self, propertyChangeEvent: PropertyChangeEvent) -> None: ...
...
class VetoableChangeListenerProxy(java.util.EventListenerProxy[VetoableChangeListener], VetoableChangeListener):
    def __init__(self, string: str, vetoableChangeListener: typing.Union[VetoableChangeListener, typing.Callable]): ...
    def getPropertyName(self) -> str: ...
    def vetoableChange(self, propertyChangeEvent: PropertyChangeEvent) -> None: ...
