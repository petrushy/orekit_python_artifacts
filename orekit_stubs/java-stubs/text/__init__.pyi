...
class NumberFormat(Format):
    ...
    class Style(java.lang.Enum['NumberFormat.Style']):
        ...
        @staticmethod
        def values() -> typing.List['NumberFormat.Style']: ...
...
class CompactNumberFormat(NumberFormat):
    @typing.overload
    def __init__(self, string: str, decimalFormatSymbols: DecimalFormatSymbols, stringArray: typing.List[str]): ...
    @typing.overload
    def __init__(self, string: str, decimalFormatSymbols: DecimalFormatSymbols, stringArray: typing.List[str], string3: str): ...
