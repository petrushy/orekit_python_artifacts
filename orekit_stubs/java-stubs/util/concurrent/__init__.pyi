...
class ForkJoinTask(Future[_ForkJoinTask__V], java.io.Serializable, typing.Generic[_ForkJoinTask__V]):
    ...
    @typing.overload
    @staticmethod
    def invokeAll(collection: typing.Union[java.util.Collection[_invokeAll_0__T], typing.Sequence[_invokeAll_0__T]]) -> java.util.Collection[_invokeAll_0__T]: ...
    @typing.overload
    @staticmethod
...
class StructuredTaskScope(java.lang.AutoCloseable, typing.Generic[_StructuredTaskScope__T]):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, string: str, threadFactory: ThreadFactory): ...
    def close(self) -> None: ...
    ...
    class Subtask(java.util.function.Supplier[_StructuredTaskScope__Subtask__T], typing.Generic[_StructuredTaskScope__Subtask__T]):
        ...
        class State(java.lang.Enum['StructuredTaskScope.Subtask.State']):
            ...
            @staticmethod
            def values() -> typing.List['StructuredTaskScope.Subtask.State']: ...
