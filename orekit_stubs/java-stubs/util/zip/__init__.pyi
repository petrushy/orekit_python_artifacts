...
class Deflater:
    ...
    @typing.overload
    def deflate(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> int: ...
    @typing.overload
    def deflate(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int, int2: int) -> int: ...
    @typing.overload
    def deflate(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int, int2: int, int3: int) -> int: ...
    @typing.overload
    ...
    def reset(self) -> None: ...
    @typing.overload
    def setDictionary(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> None: ...
    @typing.overload
    def setDictionary(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int, int2: int) -> None: ...
    @typing.overload
    def setDictionary(self, byteBuffer: java.nio.ByteBuffer) -> None: ...
    @typing.overload
    def setInput(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> None: ...
    @typing.overload
    def setInput(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int, int2: int) -> None: ...
    @typing.overload
...
class Inflater:
    ...
    def getTotalOut(self) -> int: ...
    @typing.overload
    def inflate(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> int: ...
    @typing.overload
    def inflate(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int, int2: int) -> int: ...
    @typing.overload
...
class ZipEntry(java.util.zip.ZipConstants, java.lang.Cloneable):
    ...
    def getExtra(self) -> typing.MutableSequence[int]: ...
    ...
    def setExtra(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> None: ...
