...
class AccessController:
    ...
    @typing.overload
    @staticmethod
    def doPrivileged(privilegedAction: typing.Union['PrivilegedAction'[_doPrivileged_2__T], typing.Callable[[], _doPrivileged_2__T]], accessControlContext: AccessControlContext, permissionArray: typing.List['Permission']) -> _doPrivileged_2__T: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def doPrivileged(privilegedExceptionAction: typing.Union['PrivilegedExceptionAction'[_doPrivileged_5__T], typing.Callable[[], _doPrivileged_5__T]], accessControlContext: AccessControlContext, permissionArray: typing.List['Permission']) -> _doPrivileged_5__T: ...
    ...
    @typing.overload
    @staticmethod
    def doPrivilegedWithCombiner(privilegedAction: typing.Union['PrivilegedAction'[_doPrivilegedWithCombiner_1__T], typing.Callable[[], _doPrivilegedWithCombiner_1__T]], accessControlContext: AccessControlContext, permissionArray: typing.List['Permission']) -> _doPrivilegedWithCombiner_1__T: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def doPrivilegedWithCombiner(privilegedExceptionAction: typing.Union['PrivilegedExceptionAction'[_doPrivilegedWithCombiner_3__T], typing.Callable[[], _doPrivilegedWithCombiner_3__T]], accessControlContext: AccessControlContext, permissionArray: typing.List['Permission']) -> _doPrivilegedWithCombiner_3__T: ...
    @staticmethod
