...
class XECPrivateKey(XECKey, java.security.PrivateKey):
    def getScalar(self) -> java.util.Optional[typing.MutableSequence[int]]: ...
...
class RSAMultiPrimePrivateCrtKey(RSAPrivateKey):
    ...
    def getOtherPrimeInfo(self) -> typing.MutableSequence[java.security.spec.RSAOtherPrimeInfo]: ...
