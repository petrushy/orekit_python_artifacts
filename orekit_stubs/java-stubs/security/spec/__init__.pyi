...
class EdDSAParameterSpec(AlgorithmParameterSpec):
    ...
    @typing.overload
    def __init__(self, boolean: bool, byteArray: typing.List[int]): ...
    def getContext(self) -> java.util.Optional[typing.List[int]]: ...
    def isPrehash(self) -> bool: ...

class EdECPrivateKeySpec(KeySpec):
    def __init__(self, namedParameterSpec: 'NamedParameterSpec', byteArray: typing.List[int]): ...
