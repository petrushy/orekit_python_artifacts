...
class AccessFlag(java.lang.Enum['AccessFlag']):
    ...
    @staticmethod
    def values() -> typing.List['AccessFlag']: ...
    class Location(java.lang.Enum['AccessFlag.Location']):
        ...
        @staticmethod
        def values() -> typing.List['AccessFlag.Location']: ...
...
class Array:
    ...
    @typing.overload
    @staticmethod
    def newInstance(class_: typing.Type[typing.Any], intArray: typing.List[int]) -> typing.Any: ...
    @staticmethod
...
class ClassFileFormatVersion(java.lang.Enum['ClassFileFormatVersion']):
    ...
    @staticmethod
    def values() -> typing.List['ClassFileFormatVersion']: ...
...
class InvocationHandler:
    ...
    @staticmethod
    def invokeDefault(object: typing.Any, method: 'Method', objectArray: typing.List[typing.Any]) -> typing.Any: ...
...
class Proxy(java.io.Serializable):
    ...
    @staticmethod
    def getProxyClass(classLoader: java.lang.ClassLoader, classArray: typing.List[typing.Type[typing.Any]]) -> typing.Type[typing.Any]: ...
    @staticmethod
