...
class StringTemplate:
    ...
    @typing.overload
    @staticmethod
    def combine(stringTemplateArray: typing.List['StringTemplate']) -> 'StringTemplate': ...
    @typing.overload
    @staticmethod
...
class Enum(java.lang.constant.Constable, Comparable[_Enum__E], java.io.Serializable, typing.Generic[_Enum__E]):
    ...
    class EnumDesc(java.lang.constant.DynamicConstantDesc[_Enum__EnumDesc__E], typing.Generic[_Enum__EnumDesc__E]):
        ...
        @typing.overload
        @staticmethod
        def of(directMethodHandleDesc: java.lang.constant.DirectMethodHandleDesc, constantDescArray: typing.List[java.lang.constant.ConstantDesc]) -> java.lang.constant.DynamicConstantDesc[_of_2__T]: ...
...
class String(java.io.Serializable, Comparable[str], CharSequence, java.lang.constant.Constable, java.lang.constant.ConstantDesc, _JStringProto):
    ...
    def formatted(self, objectArray: typing.List[typing.Any]) -> str: ...
    @typing.overload
    ...
    def splitWithDelimiters(self, string: str, int: int) -> typing.List[str]: ...
    @typing.overload
