...
class ConstantDescs:
    ...
    @staticmethod
    def ofCallsiteBootstrap(classDesc: 'ClassDesc', string: str, classDesc2: 'ClassDesc', classDescArray: typing.List['ClassDesc']) -> 'DirectMethodHandleDesc': ...
    @staticmethod
    def ofConstantBootstrap(classDesc: 'ClassDesc', string: str, classDesc2: 'ClassDesc', classDescArray: typing.List['ClassDesc']) -> 'DirectMethodHandleDesc': ...
...
class DynamicCallSiteDesc:
    ...
    @typing.overload
    @staticmethod
    def of(directMethodHandleDesc: 'DirectMethodHandleDesc', string: str, methodTypeDesc: 'MethodTypeDesc', constantDescArray: typing.List[ConstantDesc]) -> 'DynamicCallSiteDesc': ...
    @typing.overload
    @staticmethod
    ...
    def withArgs(self, constantDescArray: typing.List[ConstantDesc]) -> 'DynamicCallSiteDesc': ...
...
class ClassDesc(ConstantDesc, java.lang.invoke.TypeDescriptor.OfField['ClassDesc']):
    ...
    @typing.overload
    def nested(self, string: str, stringArray: typing.List[str]) -> 'ClassDesc': ...
    @typing.overload
    @staticmethod
...
class DynamicConstantDesc(ConstantDesc, typing.Generic[_DynamicConstantDesc__T]):
    ...
    @typing.overload
    @staticmethod
    def of(directMethodHandleDesc: 'DirectMethodHandleDesc', constantDescArray: typing.List[ConstantDesc]) -> 'DynamicConstantDesc'[_of_1__T]: ...
    ...
    @staticmethod
    def ofNamed(directMethodHandleDesc: 'DirectMethodHandleDesc', string: str, classDesc: ClassDesc, constantDescArray: typing.List[ConstantDesc]) -> 'DynamicConstantDesc'[_ofNamed__T]: ...
...
class MethodHandleDesc(ConstantDesc):
    ...
    @staticmethod
    def ofConstructor(classDesc: ClassDesc, classDescArray: typing.List[ClassDesc]) -> 'DirectMethodHandleDesc': ...
    @staticmethod
...
class MethodTypeDesc(ConstantDesc, java.lang.invoke.TypeDescriptor.OfMethod[ClassDesc, 'MethodTypeDesc']):
    ...
    def equals(self, object: typing.Any) -> bool: ...
    def insertParameterTypes(self, int: int, classDescArray: typing.List[ClassDesc]) -> 'MethodTypeDesc': ...
    @typing.overload
    @staticmethod
    def of(classDesc: ClassDesc) -> 'MethodTypeDesc': ...
    @typing.overload
    @staticmethod
    def of(classDesc: ClassDesc, classDescArray: typing.List[ClassDesc]) -> 'MethodTypeDesc': ...
    @typing.overload
    @staticmethod
