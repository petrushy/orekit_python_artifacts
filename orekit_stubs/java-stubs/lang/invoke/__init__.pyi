...
class MethodHandles:
    ...
    class Lookup:
        ...
        def defineHiddenClass(self, byteArray: typing.List[int], boolean: bool, *classOption: 'MethodHandles.Lookup.ClassOption') -> 'MethodHandles.Lookup': ...
        def defineHiddenClassWithClassData(self, byteArray: typing.List[int], object: typing.Any, boolean: bool, *classOption: 'MethodHandles.Lookup.ClassOption') -> 'MethodHandles.Lookup': ...
