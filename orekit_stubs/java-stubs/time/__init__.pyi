...
class DayOfWeek(java.lang.Enum['DayOfWeek'], java.time.temporal.TemporalAccessor, java.time.temporal.TemporalAdjuster):
    ...
    @staticmethod
    def from_(temporalAccessor: java.time.temporal.TemporalAccessor) -> 'DayOfWeek': ...
    ...
    @staticmethod
    def values() -> typing.MutableSequence['DayOfWeek']: ...
...
class Duration(java.time.temporal.TemporalAmount, java.lang.Comparable['Duration'], java.io.Serializable):
    ...
    def equals(self, object: typing.Any) -> bool: ...
    @staticmethod
    def from_(temporalAmount: java.time.temporal.TemporalAmount) -> 'Duration': ...
...
class Instant(java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.lang.Comparable['Instant'], java.io.Serializable):
    ...
    def equals(self, object: typing.Any) -> bool: ...
    @staticmethod
    def from_(temporalAccessor: java.time.temporal.TemporalAccessor) -> 'Instant': ...
    def get(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    ...
    @typing.overload
    def with_(self, temporalAdjuster: typing.Union[java.time.temporal.TemporalAdjuster, typing.Callable]) -> 'Instant': ...
    @typing.overload
...
class LocalDate(java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.time.chrono.ChronoLocalDate, java.io.Serializable):
    ...
    @staticmethod
    def from_(temporalAccessor: java.time.temporal.TemporalAccessor) -> 'LocalDate': ...
    def get(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    ...
    @typing.overload
    def with_(self, temporalAdjuster: typing.Union[java.time.temporal.TemporalAdjuster, typing.Callable]) -> 'LocalDate': ...
    @typing.overload
    def with_(self, temporalField: java.time.temporal.TemporalField, long: int) -> 'LocalDate': ...
...
class LocalDateTime(java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.time.chrono.ChronoLocalDateTime[LocalDate], java.io.Serializable):
    ...
    def format(self, dateTimeFormatter: java.time.format.DateTimeFormatter) -> str: ...
    @staticmethod
    def from_(temporalAccessor: java.time.temporal.TemporalAccessor) -> 'LocalDateTime': ...
    def get(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getDayOfMonth(self) -> int: ...
    def getDayOfWeek(self) -> DayOfWeek: ...
    def getDayOfYear(self) -> int: ...
    ...
    @typing.overload
    def with_(self, temporalAdjuster: typing.Union[java.time.temporal.TemporalAdjuster, typing.Callable]) -> 'LocalDateTime': ...
    @typing.overload
    def with_(self, temporalField: java.time.temporal.TemporalField, long: int) -> 'LocalDateTime': ...
...
class LocalTime(java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.lang.Comparable['LocalTime'], java.io.Serializable):
    ...
    def format(self, dateTimeFormatter: java.time.format.DateTimeFormatter) -> str: ...
    @staticmethod
    def from_(temporalAccessor: java.time.temporal.TemporalAccessor) -> 'LocalTime': ...
    def get(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getHour(self) -> int: ...
    def getLong(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getMinute(self) -> int: ...
    ...
    @typing.overload
    def with_(self, temporalAdjuster: typing.Union[java.time.temporal.TemporalAdjuster, typing.Callable]) -> 'LocalTime': ...
    @typing.overload
    def with_(self, temporalField: java.time.temporal.TemporalField, long: int) -> 'LocalTime': ...
...
class Month(java.lang.Enum['Month'], java.time.temporal.TemporalAccessor, java.time.temporal.TemporalAdjuster):
    ...
    @staticmethod
    def from_(temporalAccessor: java.time.temporal.TemporalAccessor) -> 'Month': ...
    def get(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getDisplayName(self, textStyle: java.time.format.TextStyle, locale: java.util.Locale) -> str: ...
    def getLong(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getValue(self) -> int: ...
...
class MonthDay(java.time.temporal.TemporalAccessor, java.time.temporal.TemporalAdjuster, java.lang.Comparable['MonthDay'], java.io.Serializable):
    ...
    def format(self, dateTimeFormatter: java.time.format.DateTimeFormatter) -> str: ...
    @staticmethod
    def from_(temporalAccessor: java.time.temporal.TemporalAccessor) -> 'MonthDay': ...
    def get(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getDayOfMonth(self) -> int: ...
    def getLong(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getMonth(self) -> Month: ...
...
class OffsetDateTime(java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.lang.Comparable['OffsetDateTime'], java.io.Serializable):
    ...
    def format(self, dateTimeFormatter: java.time.format.DateTimeFormatter) -> str: ...
    @staticmethod
    def from_(temporalAccessor: java.time.temporal.TemporalAccessor) -> 'OffsetDateTime': ...
    def get(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getDayOfMonth(self) -> int: ...
    def getDayOfWeek(self) -> DayOfWeek: ...
    def getDayOfYear(self) -> int: ...
    ...
    @typing.overload
    def with_(self, temporalAdjuster: typing.Union[java.time.temporal.TemporalAdjuster, typing.Callable]) -> 'OffsetDateTime': ...
    @typing.overload
    def with_(self, temporalField: java.time.temporal.TemporalField, long: int) -> 'OffsetDateTime': ...
...
class OffsetTime(java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.lang.Comparable['OffsetTime'], java.io.Serializable):
    ...
    def format(self, dateTimeFormatter: java.time.format.DateTimeFormatter) -> str: ...
    @staticmethod
    def from_(temporalAccessor: java.time.temporal.TemporalAccessor) -> 'OffsetTime': ...
    def get(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getHour(self) -> int: ...
    def getLong(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getMinute(self) -> int: ...
    ...
    @typing.overload
    def with_(self, temporalAdjuster: typing.Union[java.time.temporal.TemporalAdjuster, typing.Callable]) -> 'OffsetTime': ...
    @typing.overload
    def with_(self, temporalField: java.time.temporal.TemporalField, long: int) -> 'OffsetTime': ...
...
class Period(java.time.chrono.ChronoPeriod, java.io.Serializable):
    ...
    def equals(self, object: typing.Any) -> bool: ...
    @staticmethod
    def from_(temporalAmount: java.time.temporal.TemporalAmount) -> 'Period': ...
    def get(self, temporalUnit: java.time.temporal.TemporalUnit) -> int: ...
    def getChronology(self) -> java.time.chrono.IsoChronology: ...
...
class Year(java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.lang.Comparable['Year'], java.io.Serializable):
    ...
    def format(self, dateTimeFormatter: java.time.format.DateTimeFormatter) -> str: ...
    @staticmethod
    def from_(temporalAccessor: java.time.temporal.TemporalAccessor) -> 'Year': ...
    def get(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getLong(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getValue(self) -> int: ...
    def hashCode(self) -> int: ...
    ...
    def until(self, temporal: java.time.temporal.Temporal, temporalUnit: java.time.temporal.TemporalUnit) -> int: ...
    @typing.overload
    def with_(self, temporalAdjuster: typing.Union[java.time.temporal.TemporalAdjuster, typing.Callable]) -> 'Year': ...
    @typing.overload
    def with_(self, temporalField: java.time.temporal.TemporalField, long: int) -> 'Year': ...
...
class YearMonth(java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.lang.Comparable['YearMonth'], java.io.Serializable):
    ...
    def format(self, dateTimeFormatter: java.time.format.DateTimeFormatter) -> str: ...
    @staticmethod
    def from_(temporalAccessor: java.time.temporal.TemporalAccessor) -> 'YearMonth': ...
    def get(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getLong(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getMonth(self) -> Month: ...
    def getMonthValue(self) -> int: ...
    ...
    @typing.overload
    def with_(self, temporalAdjuster: typing.Union[java.time.temporal.TemporalAdjuster, typing.Callable]) -> 'YearMonth': ...
    @typing.overload
    def with_(self, temporalField: java.time.temporal.TemporalField, long: int) -> 'YearMonth': ...

class ZoneId(java.io.Serializable):
    SHORT_IDS: typing.ClassVar[java.util.Map] = ...
    def equals(self, object: typing.Any) -> bool: ...
    @staticmethod
    def from_(temporalAccessor: java.time.temporal.TemporalAccessor) -> 'ZoneId': ...
    @staticmethod
...
class ZonedDateTime(java.time.temporal.Temporal, java.time.chrono.ChronoZonedDateTime[LocalDate], java.io.Serializable):
    ...
    def format(self, dateTimeFormatter: java.time.format.DateTimeFormatter) -> str: ...
    @staticmethod
    def from_(temporalAccessor: java.time.temporal.TemporalAccessor) -> 'ZonedDateTime': ...
    def get(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getDayOfMonth(self) -> int: ...
    def getDayOfWeek(self) -> DayOfWeek: ...
    def getDayOfYear(self) -> int: ...
    ...
    @typing.overload
    def with_(self, temporalAdjuster: typing.Union[java.time.temporal.TemporalAdjuster, typing.Callable]) -> 'ZonedDateTime': ...
    @typing.overload
...
class ZoneOffset(ZoneId, java.time.temporal.TemporalAccessor, java.time.temporal.TemporalAdjuster, java.lang.Comparable['ZoneOffset'], java.io.Serializable):
    ...
    @typing.overload
    @staticmethod
    def from_(temporalAccessor: java.time.temporal.TemporalAccessor) -> 'ZoneOffset': ...
    def get(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getId(self) -> str: ...
    def getLong(self, temporalField: java.time.temporal.TemporalField) -> int: ...
    def getRules(self) -> java.time.zone.ZoneRules: ...
