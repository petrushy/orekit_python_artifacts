...
class HttpRequest:
    ...
    class BodyPublishers:
        ...
        @typing.overload
        @staticmethod
        def ofByteArray(byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> 'HttpRequest.BodyPublisher': ...
        @typing.overload
        @staticmethod
        def ofByteArray(byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int, int2: int) -> 'HttpRequest.BodyPublisher': ...
        @staticmethod
        def ofByteArrays(iterable: typing.Union[java.lang.Iterable[typing.Union[typing.List[int], jpype.JArray, bytes]], typing.Sequence[typing.Union[typing.List[int], jpype.JArray, bytes]], typing.Set[typing.Union[typing.List[int], jpype.JArray, bytes]], typing.Callable[[], java.util.Iterator[typing.Any]]]) -> 'HttpRequest.BodyPublisher': ...
        @staticmethod
...
class HttpResponse(typing.Generic[_HttpResponse__T]):
    ...
    class BodyHandlers:
        ...
        @staticmethod
        def ofByteArrayConsumer(consumer: typing.Union[java.util.function.Consumer[java.util.Optional[typing.Union[typing.List[int], jpype.JArray, bytes]]], typing.Callable[[java.util.Optional[typing.Union[typing.List[int], jpype.JArray, bytes]]], None]]) -> 'HttpResponse.BodyHandler'[None]: ...
        @typing.overload
        @staticmethod
    ...
    class BodySubscribers:
        ...
        @staticmethod
        def ofByteArray() -> 'HttpResponse.BodySubscriber'[typing.MutableSequence[int]]: ...
        @staticmethod
        def ofByteArrayConsumer(consumer: typing.Union[java.util.function.Consumer[java.util.Optional[typing.Union[typing.List[int], jpype.JArray, bytes]]], typing.Callable[[java.util.Optional[typing.Union[typing.List[int], jpype.JArray, bytes]]], None]]) -> 'HttpResponse.BodySubscriber'[None]: ...
        @typing.overload
        @staticmethod
