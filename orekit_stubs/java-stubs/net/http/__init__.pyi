...
class HttpRequest:
    ...
    class BodyPublishers:
        @staticmethod
        def concat(bodyPublisherArray: typing.List['HttpRequest.BodyPublisher']) -> 'HttpRequest.BodyPublisher': ...
        @typing.overload
        @staticmethod
        ...
        @staticmethod
        def ofByteArrays(iterable: java.lang.Iterable[typing.List[int]]) -> 'HttpRequest.BodyPublisher': ...
        @staticmethod
    ...
    class Builder:
        ...
        def headers(self, stringArray: typing.List[str]) -> 'HttpRequest.Builder': ...
...
class HttpResponse(typing.Generic[_HttpResponse__T]):
    ...
    class BodyHandlers:
        ...
        @typing.overload
        @staticmethod
        def ofFile(path: typing.Union[java.nio.file.Path, jpype.protocol.SupportsPath], openOptionArray: typing.List[java.nio.file.OpenOption]) -> 'HttpResponse.BodyHandler'[java.nio.file.Path]: ...
        @staticmethod
        def ofFileDownload(path: typing.Union[java.nio.file.Path, jpype.protocol.SupportsPath], openOptionArray: typing.List[java.nio.file.OpenOption]) -> 'HttpResponse.BodyHandler'[java.nio.file.Path]: ...
        @staticmethod
    ...
    class BodySubscribers:
        ...
        @typing.overload
        @staticmethod
        def ofFile(path: typing.Union[java.nio.file.Path, jpype.protocol.SupportsPath], openOptionArray: typing.List[java.nio.file.OpenOption]) -> 'HttpResponse.BodySubscriber'[java.nio.file.Path]: ...
        @staticmethod
