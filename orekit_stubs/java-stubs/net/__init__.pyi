...
class ContentHandler:
    ...
    @typing.overload
    def getContent(self, uRLConnection: 'URLConnection', classArray: typing.Union[typing.List[typing.Type], jpype.JArray]) -> typing.Any: ...
...
class DatagramPacket:
    ...
    @typing.overload
    def __init__(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int, int2: int, inetAddress: 'InetAddress', int3: int): ...
    @typing.overload
    def __init__(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int, int2: int, socketAddress: 'SocketAddress'): ...
    @typing.overload
    def __init__(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int, inetAddress: 'InetAddress', int2: int): ...
    @typing.overload
    def __init__(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int, socketAddress: 'SocketAddress'): ...
    ...
    @typing.overload
    def setData(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> None: ...
    @typing.overload
    def setData(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int, int2: int) -> None: ...
...
class DatagramSocket(java.io.Closeable):
    ...
    @staticmethod
    def setDatagramSocketImplFactory(datagramSocketImplFactory: typing.Union['DatagramSocketImplFactory', typing.Callable]) -> None: ...
...
class InetAddress(java.io.Serializable):
    ...
    @staticmethod
    def getAllByName(string: str) -> typing.MutableSequence['InetAddress']: ...
    @typing.overload
    @staticmethod
    def getByAddress(byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> 'InetAddress': ...
    @typing.overload
    @staticmethod
    def getByAddress(string: str, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> 'InetAddress': ...
    @staticmethod
...
class PasswordAuthentication:
    def __init__(self, string: str, charArray: typing.Union[typing.List[str], jpype.JArray]): ...
...
class ServerSocket(java.io.Closeable):
    ...
    def setSoTimeout(self, int: int) -> None: ...
    @staticmethod
    def setSocketFactory(socketImplFactory: typing.Union['SocketImplFactory', typing.Callable]) -> None: ...
    def supportedOptions(self) -> java.util.Set['SocketOption'[typing.Any]]: ...
    def toString(self) -> str: ...
...
class Socket(java.io.Closeable):
    ...
    def setSoTimeout(self, int: int) -> None: ...
    @staticmethod
    def setSocketImplFactory(socketImplFactory: typing.Union['SocketImplFactory', typing.Callable]) -> None: ...
...
class URL(java.io.Serializable):
    ...
    @typing.overload
    def getContent(self, classArray: typing.Union[typing.List[typing.Type[typing.Any]], jpype.JArray]) -> typing.Any: ...
    ...
    @staticmethod
    def setURLStreamHandlerFactory(uRLStreamHandlerFactory: typing.Union['URLStreamHandlerFactory', typing.Callable]) -> None: ...
...
class URLClassLoader(java.security.SecureClassLoader, java.io.Closeable):
    @typing.overload
    def __init__(self, string: str, uRLArray: typing.Union[typing.List[URL], jpype.JArray], classLoader: java.lang.ClassLoader): ...
    @typing.overload
    def __init__(self, string: str, uRLArray: typing.Union[typing.List[URL], jpype.JArray], classLoader: java.lang.ClassLoader, uRLStreamHandlerFactory: typing.Union['URLStreamHandlerFactory', typing.Callable]): ...
    @typing.overload
    def __init__(self, uRLArray: typing.Union[typing.List[URL], jpype.JArray]): ...
    @typing.overload
    def __init__(self, uRLArray: typing.Union[typing.List[URL], jpype.JArray], classLoader: java.lang.ClassLoader): ...
    @typing.overload
    def __init__(self, uRLArray: typing.Union[typing.List[URL], jpype.JArray], classLoader: java.lang.ClassLoader, uRLStreamHandlerFactory: typing.Union['URLStreamHandlerFactory', typing.Callable]): ...
    def close(self) -> None: ...
    ...
    @typing.overload
    @staticmethod
    def newInstance(uRLArray: typing.Union[typing.List[URL], jpype.JArray]) -> 'URLClassLoader': ...
    @typing.overload
    @staticmethod
    def newInstance(uRLArray: typing.Union[typing.List[URL], jpype.JArray], classLoader: java.lang.ClassLoader) -> 'URLClassLoader': ...
...
class URLConnection:
    ...
    @staticmethod
    def setContentHandlerFactory(contentHandlerFactory: typing.Union[ContentHandlerFactory, typing.Callable]) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def setFileNameMap(fileNameMap: typing.Union[FileNameMap, typing.Callable]) -> None: ...
...
class CookieManager(CookieHandler):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, cookieStore: CookieStore, cookiePolicy: typing.Union[CookiePolicy, typing.Callable]): ...
    def get(self, uRI: URI, map: typing.Union[java.util.Map[str, java.util.List[str]], typing.Mapping[str, java.util.List[str]]]) -> java.util.Map[str, java.util.List[str]]: ...
    def getCookieStore(self) -> CookieStore: ...
    def put(self, uRI: URI, map: typing.Union[java.util.Map[str, java.util.List[str]], typing.Mapping[str, java.util.List[str]]]) -> None: ...
    def setCookiePolicy(self, cookiePolicy: typing.Union[CookiePolicy, typing.Callable]) -> None: ...
...
class Inet6Address(InetAddress):
    ...
    @typing.overload
    @staticmethod
    def getByAddress(string: str, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int) -> 'Inet6Address': ...
    @typing.overload
    @staticmethod
    def getByAddress(string: str, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], networkInterface: NetworkInterface) -> 'Inet6Address': ...
    @typing.overload
    @staticmethod
    def getByAddress(byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> InetAddress: ...
    @typing.overload
