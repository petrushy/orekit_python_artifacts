...
class MultipleLinearRegression:
    ...
    The multiple linear regression can be represented in matrix-notation.
      ...
      y=X*b+u where y is an n-vector regressand, X is a [n,k] matrix whose k columns are called regressors, b is k-vector of regression parameters and u is an n-vector of error terms or residuals. The notation is quite standard in literature, cf eg `Davidson and MacKinnon, Econometrics Theory and Methods, 2004 <http://www.econ.queensu.ca/ETM>`.
    """
...
class RegressionResults(java.io.Serializable):
    ...
    def __init__(self, parameters: typing.Union[typing.List[float], jpype.JArray], varcov: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], isSymmetricCompressed: bool, nobs: int, rank: int, sumy: float, sumysq: float, sse: float, containsConstant: bool, copyData: bool):
        ...
        Parameters:
            parameters (double[]): a double array with the regression slope estimates
            varcov (double[][]): the variance covariance matrix, stored either in a square matrix or as a compressed
            isSymmetricCompressed (boolean): a flag which denotes that the variance covariance matrix is in symmetric compressed format
            nobs (long): the number of observations of the regression estimation
            rank (int): the number of independent variables in the regression
            sumy (double): the sum of the independent variable
            sumysq (double): the sum of the squared independent variable
            sse (double): sum of squared errors
            containsConstant (boolean): true model has constant, false model does not have constant
            copyData (boolean): if true a deep copy of all input data is made, if false only references are copied and the RegressionResults become
                mutable
    ...
    def getAdjustedRSquared(self) -> float:
        ...
        """
        ...
    def getCovarianceOfParameters(self, i: int, j: int) -> float:
        """
        Returns the covariance between regression parameters i and j.
        
        If there are problems with an ill conditioned design matrix then the covariance which involves redundant columns will be assigned NaN.
        
        Parameters:
            i (int): ith regression parameter.
            j (int): jth regression parameter.
        
        Returns:
            the covariance of the parameter estimates.
        
        Raises:
            hipparchus: if i or j is not in the interval [0, number of parameters).
    ...
    def getErrorSumSquares(self) -> float:
        """
        Returns the ` sum of squared errors <http://www.xycoon.com/SumOfSquares.htm>` (SSE) associated with the regression model.
        ...
        Preconditions:
          ...
          - numberOfParameters data pairs must have been added before invoking this method. If this method is invoked before a model
            can be estimated, Double,NaN is returned.
    ...
    def getMeanSquareError(self) -> float:
        ...
        If there are fewer than numberOfParameters + 1 data pairs in the model, or if there is no variation in x, this returns NaN.
    ...
    def getNumberOfParameters(self) -> int:
        ...
        """
        ...
    def getParameterEstimate(self, index: int) -> float:
        """
        Returns the parameter estimate for the regressor at the given index.
        
        A redundant regressor will have its redundancy flag set, as well as a parameters estimated equal to NaN
        ...
        Raises:
            hipparchus: if index is not in the interval [0, number of parameters).
    ...
    def getParameterEstimates(self) -> typing.MutableSequence[float]:
        ...
        A redundant regressor will have its redundancy flag set, as will a parameter estimate equal to NaN.
    ...
    def getRSquared(self) -> float:
        ...
        Preconditions:
          ...
          - At least numberOfParameters observations (with at least numberOfParameters different x values) must have been added
            before invoking this method. If this method is invoked before a model can be estimated, Double,NaN is returned.
    ...
    def getRegressionSumSquares(self) -> float:
        ...
        Preconditions:
          ...
          - At least two observations (with at least two different x values) must have been added before invoking this method. If
            this method is invoked before a model can be estimated, NaN is returned.
        ...
        """
        ...
    def getStdErrorOfEstimate(self, index: int) -> float:
        """
        Returns the `standard error of the parameter estimate at index <http://www.xycoon.com/standerrorb(1).htm>`, usually denoted s(b :sub:`index` ).
    ...
    def getStdErrorOfEstimates(self) -> typing.MutableSequence[float]:
        """
        Returns the `standard error of the parameter estimates <http://www.xycoon.com/standerrorb(1).htm>`, usually denoted s(b :sub:`i` ).
        
        If there are problems with an ill conditioned design matrix then the regressor which is redundant will be assigned NaN.
    ...
    def hasIntercept(self) -> bool:
        """
        Returns true if the regression model has been computed including an intercept. In this case, the coefficient of the intercept is the first element of the getParameterEstimates.
...
class UpdatingMultipleLinearRegression:
    ...
    def addObservation(self, x: typing.Union[typing.List[float], jpype.JArray], y: float) -> None:
        ...
        Raises:
            hipparchus: if the length of x does not equal the number of independent variables in the model
        
        
        """
        ...
    def addObservations(self, x: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], y: typing.Union[typing.List[float], jpype.JArray]) -> None:
        """
        ...
        Raises:
            hipparchus: if x is not rectangular, does not match the length of y or does not contain sufficient data to estimate
                the model
...
class AbstractMultipleLinearRegression(MultipleLinearRegression):
    ...
    def estimateRegressandVariance(self) -> float:
        ...
        Specified by: estimateRegressandVariance in interface MultipleLinearRegression
    ...
    def estimateRegressionParameters(self) -> typing.MutableSequence[float]:
        ...
        Specified by: estimateRegressionParameters in interface MultipleLinearRegression
    ...
    def estimateRegressionParametersStandardErrors(self) -> typing.MutableSequence[float]:
        ...
        Specified by: estimateRegressionParametersStandardErrors in interface MultipleLinearRegression
    ...
    def estimateRegressionParametersVariance(self) -> typing.MutableSequence[typing.MutableSequence[float]]:
        ...
        Specified by: estimateRegressionParametersVariance in interface MultipleLinearRegression
    ...
    def estimateResiduals(self) -> typing.MutableSequence[float]:
        ...
        Specified by: estimateResiduals in interface MultipleLinearRegression
    ...
    def newSampleData(self, data: typing.Union[typing.List[float], jpype.JArray], nobs: int, nvars: int) -> None:
        ...
        Raises:
            hipparchus: if the data array is null
            hipparchus: if the length of the data array is not equal to nobs * (nvars + 1)
            hipparchus: if nobs is less than nvars + 1
        
        
        """
        ...
    def setNoIntercept(self, noIntercept: bool) -> None:
        """
        Set intercept flag.
...
class MillerUpdatingRegression(UpdatingMultipleLinearRegression):
    ...
    The algorithm is described in:
     ...
     Algorithm AS 274: Least Squares Routines to Supplement Those of Gentleman Author(s): Alan J. Miller Source: Journal of the Royal Statistical Society. Series C (Applied Statistics), Vol. 41, No. 2 (1992), pp. 458-478 Published by: Blackwell Publishing for the Royal Statistical Society Stable URL: stable
    ...
    def addObservation(self, x: typing.Union[typing.List[float], jpype.JArray], y: float) -> None:
        ...
        Specified by: addObservation in interface UpdatingMultipleLinearRegression
        
        Parameters:
            x (double[]): the array with regressor values
            y (double): the value of dependent variable given these regressors
    ...
    def addObservations(self, x: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], y: typing.Union[typing.List[float], jpype.JArray]) -> None:
        ...
        Specified by: addObservations in interface UpdatingMultipleLinearRegression
        
        Parameters:
            x (double[][]): observations on the regressors
            y (double[]): observations on the regressand
    ...
    def clear(self) -> None:
        ...
        Specified by: clear in interface UpdatingMultipleLinearRegression
        
        
        """
        ...
    def getDiagonalOfHatMatrix(self, row_data: typing.Union[typing.List[float], jpype.JArray]) -> float:
        """
    ...
    def getN(self) -> int:
        ...
        Specified by: getN in interface UpdatingMultipleLinearRegression
    ...
    def getOrderOfRegressors(self) -> typing.MutableSequence[int]:
        ...
        """
        ...
    def getPartialCorrelations(self, in_: int) -> typing.MutableSequence[float]:
        """
    ...
    def hasIntercept(self) -> bool:
        ...
        Specified by: hasIntercept in interface UpdatingMultipleLinearRegression
...
class SimpleRegression(java.io.Serializable, UpdatingMultipleLinearRegression):
    ...
    * Usage Notes:
      ...
      - When there are fewer than two observations in the model, or when there is no variation in the x values (i.e. all x
        values are the same) all statistics return NaN. At least two observations with different x coordinates are
      ...
      - The intercept term may be suppressed by passing false to the
         constructor. When the hasIntercept property
    ...
    def addData(self, double: float, double2: float) -> None:
        ...
        Raises:
            hipparchus: if the length of data[i] is not greater than or equal to 2
    ...
    def addObservations(self, x: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], y: typing.Union[typing.List[float], jpype.JArray]) -> None:
        ...
        """
        ...
    def append(self, reg: 'SimpleRegression') -> None:
        """
        Appends data from another regression calculation to this one.
        
        The mean update formulae are based on a paper written by Philippe Pébay: ` Formulas for Robust, One-Pass Parallel Computation of Covariances and Arbitrary-Order Statistical Moments <http://prod.sandia.gov/techlib/access-control.cgi/2008/086212.pdf>`, 2008, Technical Report SAND2008-6212, Sandia National Laboratories.
        
        Parameters:
            reg (SimpleRegression): model to append data from
    ...
    def getIntercept(self) -> float:
        ...
        The least squares estimate of the intercept is computed using the `normal equations <http://www.xycoon.com/estimation4.htm>`. The intercept is sometimes denoted b0.
        
        Preconditions:
        
          - At least two observations (with at least two different x values) must have been added before invoking this method. If
            this method is invoked before a model can be estimated, Double,NaN is returned.
    ...
    def getInterceptStdErr(self) -> float:
        ...
        If there are fewer that three observations in the model, or if there is no variation in x, this returns NaN. Additionally, a NaN is returned when the intercept is constrained to be zero
    ...
    def getMeanSquareError(self) -> float:
        ...
        If there are fewer than three data pairs in the model, or if there is no variation in x, this returns NaN.
    ...
    def getR(self) -> float:
        """
        Returns ` Pearson's product moment correlation coefficient <http://mathworld.wolfram.com/CorrelationCoefficient.html>`, usually denoted r.
    ...
    def getSignificance(self) -> float:
        ...
        Specifically, the returned value is the smallest alpha such that the slope confidence interval with significance level equal to alpha does not include . On regression output, this is often denoted Prob(|t| > 0)
        
        Usage Note:
        
        The validity of this statistic depends on the assumption that the observations included in the model are drawn from a ` Bivariate Normal Distribution <http://mathworld.wolfram.com/BivariateNormalDistribution.html>`.
        
        If there are fewer that three observations in the model, or if there is no variation in x, this returns NaN.
        
        Returns:
            significance level for slope/correlation
        
        Raises:
            hipparchus: if the significance level can not be computed.
    ...
    def getSlope(self) -> float:
        ...
        The least squares estimate of the slope is computed using the `normal equations <http://www.xycoon.com/estimation4.htm>`. The slope is sometimes denoted b1.
    ...
    def getSlopeStdErr(self) -> float:
        ...
        If there are fewer that three data pairs in the model, or if there is no variation in x, this returns NaN.
    ...
    def removeData(self, x: float, y: float) -> None:
        ...
        ...
    @typing.overload
    def removeData(self, data: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray]) -> None:
        """
...
class GLSMultipleLinearRegression(AbstractMultipleLinearRegression):
    ...
    def __init__(self):
        ...
        ...
    @typing.overload
    def newSampleData(self, y: typing.Union[typing.List[float], jpype.JArray], x: int, covariance: int) -> None:
        """
...
class OLSMultipleLinearRegression(AbstractMultipleLinearRegression):
    ...
    To solve the normal equations, this implementation uses QR decomposition of the X matrix. (See hipparchus for details on the decomposition algorithm.) The X matrix, also known as the design matrix, has rows corresponding to sample observations and columns corresponding to independent variables. When the model is estimated using an intercept term (i.e. when isNoIntercept is false as it is by default), the X matrix includes an initial column identically equal to 1. We solve the normal equations as follows:
    
     X :sup:`T` X b = X :sup:`T`  y (QR) :sup:`T`  (QR) b = (QR) :sup:`T` y R :sup:`T`  (Q :sup:`T` Q) R b = R :sup:`T`  Q :sup:`T`  y R :sup:`T`  R b = R :sup:`T`  Q :sup:`T`  y (R :sup:`T` ) :sup:`-1`  R :sup:`T`  R b = (R :sup:`T` ) :sup:`-1`  R :sup:`T`  Q :sup:`T`  y R b = Q :sup:`T`  y
    ...
    def calculateHat(self) -> org.hipparchus.linear.RealMatrix:
        ...
        The implementation here uses the QR decomposition to compute the hat matrix as Q I :sub:`p` Q :sup:`T` where I :sub:`p` is the p-dimensional identity matrix augmented by 0's. This computational formula is from "The Hat Matrix in Regression and ANOVA", David C. Hoaglin and Roy E. Welsch, The American Statistician, Vol. 32, No. 1 (Feb., 1978), pp. 17-22.
    ...
    def calculateRSquared(self) -> float:
        """
        Returns the R-Squared statistic, defined by the formula \(R^2 = 1 - \frac{\mathrm{SSR}}{\mathrm{SSTO}}\) where SSR is the calculateResidualSumOfSquares and SSTO is the calculateTotalSumOfSquares
    ...
    def calculateTotalSumOfSquares(self) -> float:
        ...
        If the model has no intercept term,  is used for the mean of Y - i.e., what is returned is the sum of the squared Y values.
        
        The value returned by this method is the SSTO value used in the calculateRSquared computation.
    ...
    def newSampleData(self, doubleArray: typing.Union[typing.List[float], jpype.JArray], doubleArray2: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray]) -> None:
        ...
        Overrides: newSampleData in class AbstractMultipleLinearRegression
