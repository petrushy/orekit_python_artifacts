...
class PCA:
    """
    Principal component analysis (PCA) is a statistical technique for reducing the dimensionality of a dataset. Principal_component_analysis can be thought of as a projection or scaling of the data to reduce the number of dimensions but done in a way that preserves as much information as possible.
    
    Since:
        3.0
    """
    @typing.overload
    def __init__(self, numC: int): ...
    @typing.overload
    def __init__(self, numC: int, scale: bool, biasCorrection: bool): ...
    def fit(self, data: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray]) -> 'PCA':
        """
        ...
        """
        ...
    def fitAndTransform(self, data: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray]) -> typing.MutableSequence[typing.MutableSequence[float]]:
        """
    ...
    def isScale(self) -> bool:
        ...
        """
        ...
    def transform(self, data: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray]) -> typing.MutableSequence[typing.MutableSequence[float]]:
        """
