...
class GeometricMean(org.hipparchus.stat.descriptive.AbstractStorelessUnivariateStatistic, org.hipparchus.stat.descriptive.AggregatableStatistic['GeometricMean'], java.io.Serializable):
    ...
    def aggregate(self, other: typing.Union[java.lang.Iterable[typing.Any], typing.Sequence[typing.Any], typing.Set[typing.Any], typing.Callable[[], java.util.Iterator[typing.Any]]]) -> None:
        ...
        Parameters:
            other (GeometricMean): the instance to aggregate into this instance
...
class Kurtosis(org.hipparchus.stat.descriptive.AbstractStorelessUnivariateStatistic, java.io.Serializable):
    ...
    Note that this statistic is undefined for n < 4. Nan is returned when there is not sufficient data to compute the statistic. Note that Double.NaN may also be returned if the input includes NaN and / or infinite values.
    ...
    def increment(self, d: float) -> None:
        ...
        Note that when  is used to create a Variance, this method does nothing. In that case, the FourthMoment should be incremented directly.
...
class Mean(org.hipparchus.stat.descriptive.AbstractStorelessUnivariateStatistic, org.hipparchus.stat.descriptive.AggregatableStatistic['Mean'], org.hipparchus.stat.descriptive.WeightedEvaluation, java.io.Serializable):
    ...
    When increment is used to add data incrementally from a stream of (unstored) values, the value of the statistic that getResult returns is computed using the following recursive updating algorithm:
    
      1.  Initialize m = the first value 2.  For each additional value, update using
    
    m = m + (new value - m) / (number of observations)
    
    If evaluate is used to compute the mean of an array of stored values, a two-pass, corrected algorithm is used, starting with the definitional formula computed using the array of stored values and then correcting this by adding the mean deviation of the data values from the arithmetic mean. See, e.g. "Comparison of Several Algorithms for Computing Sample Means and Variances," Robert F. Ling, Journal of the American Statistical Association, Vol. 69, No. 348 (Dec., 1974), pp. 859-866.
    
    Returns NaN if the dataset is empty. Note that Double.NaN may also be returned if the input includes NaN and / or infinite values.
    ...
    def aggregate(self, other: typing.Union[java.lang.Iterable[typing.Any], typing.Sequence[typing.Any], typing.Set[typing.Any], typing.Callable[[], java.util.Iterator[typing.Any]]]) -> None:
        ...
        Parameters:
            other (Mean): the instance to aggregate into this instance
    ...
    def increment(self, d: float) -> None:
        ...
        Note that when  is used to create a Mean, this method does nothing. In that case, the FirstMoment should be incremented directly.
...
class SemiVariance(org.hipparchus.stat.descriptive.AbstractUnivariateStatistic, java.io.Serializable):
    ...
    The cutoff value defaults to the mean, bias correction defaults to true and the "variance direction" (upside or downside) defaults to downside. The variance direction and bias correction may be set using property setters or their values can provided as parameters to evaluate.
    
    If the input array is null, evaluate methods throw IllegalArgumentException If the array has length 1, is returned, regardless of the value of the cutoff
    ...
    def isBiasCorrected(self) -> bool:
        ...
        """
        ...
    def withBiasCorrected(self, isBiasCorrected: bool) -> 'SemiVariance':
        """
    ...
    def withVarianceDirection(self, direction: 'SemiVariance.Direction') -> 'SemiVariance':
        ...
        Parameters:
            direction (Direction): the direction of the semivariance
...
class Skewness(org.hipparchus.stat.descriptive.AbstractStorelessUnivariateStatistic, java.io.Serializable):
    ...
    Note that this statistic is undefined for n < 3. Nan is returned when there is not sufficient data to compute the statistic. Double.NaN may also be returned if the input includes NaN and / or infinite values.
    ...
    def increment(self, d: float) -> None:
        ...
        Note that when  is used to create a Skewness, this method does nothing. In that case, the ThirdMoment should be incremented directly.
...
class StandardDeviation(org.hipparchus.stat.descriptive.AbstractStorelessUnivariateStatistic, java.io.Serializable):
    ...
    def isBiasCorrected(self) -> bool:
        ...
        """
        ...
    def withBiasCorrection(self, biasCorrection: bool) -> 'StandardDeviation':
        """
...
class Variance(org.hipparchus.stat.descriptive.AbstractStorelessUnivariateStatistic, org.hipparchus.stat.descriptive.AggregatableStatistic['Variance'], org.hipparchus.stat.descriptive.WeightedEvaluation, java.io.Serializable):
    ...
    def aggregate(self, other: typing.Union[java.lang.Iterable[typing.Any], typing.Sequence[typing.Any], typing.Set[typing.Any], typing.Callable[[], java.util.Iterator[typing.Any]]]) -> None:
        ...
        Parameters:
            other (Variance): the instance to aggregate into this instance
    ...
    def increment(self, d: float) -> None:
        ...
        If all values are available, it is more accurate to use evaluate rather than adding values one at a time using this method and then executing getResult, since evaluate leverages the fact that is has the full list of values together to execute a two-pass algorithm. See Variance.
        
        Note also that when  is used to create a Variance, this method does nothing. In that case, the SecondMoment should be incremented directly.
    ...
    def isBiasCorrected(self) -> bool:
        ...
        """
        ...
    def withBiasCorrection(self, biasCorrection: bool) -> 'Variance':
        """
...
class SecondMoment(FirstMoment, org.hipparchus.stat.descriptive.AggregatableStatistic['SecondMoment'], java.io.Serializable):
    ...
    Returns NaN if no data values have been added and returns  if there is just one value in the data set. Note that Double.NaN may also be returned if the input includes NaN and / or infinite values.
    ...
    def aggregate(self, other: typing.Union[java.lang.Iterable[typing.Any], typing.Sequence[typing.Any], typing.Set[typing.Any], typing.Callable[[], java.util.Iterator[typing.Any]]]) -> None:
        ...
        Parameters:
            other (SecondMoment): the instance to aggregate into this instance
