...
import org.hipparchus.fitting.class-use
import typing
...
class AbstractCurveFitter:
    def __init__(self): ...
    def fit(self, collection: typing.Union[java.util.Collection['WeightedObservedPoint'], typing.Sequence['WeightedObservedPoint']]) -> typing.List[float]: ...
...
class GaussianCurveFitter(AbstractCurveFitter):
    ...
    class ParameterGuesser:
        def __init__(self, collection: typing.Union[java.util.Collection[WeightedObservedPoint], typing.Sequence[WeightedObservedPoint]]): ...
...
class __module_protocol__(typing.Protocol):
    ...
    class-use: org.hipparchus.fitting.class-use.__module_protocol__
