...
class DSCompiler:
    ...
    @typing.overload
    def taylor(self, doubleArray: typing.List[float], int: int, *double2: float) -> float: ...
    @typing.overload
    def taylor(self, tArray: typing.List[_taylor_1__T], int: int, *t2: _taylor_1__T) -> _taylor_1__T: ...
    @typing.overload
    def taylor(self, tArray: typing.List[_taylor_2__T], int: int, *double: float) -> _taylor_2__T: ...
