...
class CalculusFieldMultivariateFunction(typing.Generic[_CalculusFieldMultivariateFunction__T]):
    def value(self, tArray: typing.List[_CalculusFieldMultivariateFunction__T]) -> _CalculusFieldMultivariateFunction__T: ...
...
class CalculusFieldMultivariateMatrixFunction(typing.Generic[_CalculusFieldMultivariateMatrixFunction__T]):
    def value(self, tArray: typing.List[_CalculusFieldMultivariateMatrixFunction__T]) -> typing.List[typing.List[_CalculusFieldMultivariateMatrixFunction__T]]: ...
...
class CalculusFieldMultivariateVectorFunction(typing.Generic[_CalculusFieldMultivariateVectorFunction__T]):
    def value(self, tArray: typing.List[_CalculusFieldMultivariateVectorFunction__T]) -> typing.List[_CalculusFieldMultivariateVectorFunction__T]: ...
...
class FieldMultivariateFunction:
    ...
    _value__T = typing.TypeVar('_value__T', bound=org.hipparchus.CalculusFieldElement)  # <T>
    def value(self, tArray: typing.List[_value__T]) -> _value__T: ...
...
class FieldMultivariateMatrixFunction:
    ...
    _value__T = typing.TypeVar('_value__T', bound=org.hipparchus.CalculusFieldElement)  # <T>
    def value(self, tArray: typing.List[_value__T]) -> typing.List[typing.List[_value__T]]: ...
...
class FieldMultivariateVectorFunction:
    ...
    _value__T = typing.TypeVar('_value__T', bound=org.hipparchus.CalculusFieldElement)  # <T>
    def value(self, tArray: typing.List[_value__T]) -> typing.List[_value__T]: ...
