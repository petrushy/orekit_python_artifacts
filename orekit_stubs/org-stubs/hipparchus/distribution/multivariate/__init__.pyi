...
class AbstractMultivariateRealDistribution(org.hipparchus.distribution.MultivariateRealDistribution):
    ...
    def getDimension(self) -> int:
        ...
        Specified by: getDimension in interface MultivariateRealDistribution
    ...
    def reseedRandomGenerator(self, seed: int) -> None:
        ...
        Specified by: reseedRandomGenerator in interface MultivariateRealDistribution
    ...
    def sample(self) -> typing.MutableSequence[float]:
        ...
        Specified by: sample in interface MultivariateRealDistribution
...
class MixtureMultivariateRealDistribution(AbstractMultivariateRealDistribution, typing.Generic[_MixtureMultivariateRealDistribution__T]):
    ...
    def reseedRandomGenerator(self, seed: int) -> None:
        ...
        Overrides: reseedRandomGenerator in class AbstractMultivariateRealDistribution
    ...
    def sample(self) -> typing.MutableSequence[float]:
        ...
        Specified by: sample in class AbstractMultivariateRealDistribution
...
class MultivariateNormalDistribution(AbstractMultivariateRealDistribution):
    ...
    def density(self, vals: typing.Union[typing.List[float], jpype.JArray]) -> float:
        ...
        Parameters:
            vals (double[]): Point at which the PDF is evaluated.
