...
class FieldProbabilityOfCollision(typing.Generic[_FieldProbabilityOfCollision__T]):
    ...
    """
    @typing.overload
    def __init__(self, value: _FieldProbabilityOfCollision__T, probabilityOfCollisionMethodName: str): ...
    @typing.overload
    def __init__(self, value: _FieldProbabilityOfCollision__T, probabilityOfCollisionMethodName: str, isMaxProbability: bool): ...
    @typing.overload
    def __init__(self, value: _FieldProbabilityOfCollision__T, lowerLimit: _FieldProbabilityOfCollision__T, upperLimit: _FieldProbabilityOfCollision__T, probabilityOfCollisionMethodName: str, isMaxProbability: bool): ...
...
class ProbabilityOfCollision:
    ...
    """
    @typing.overload
    def __init__(self, value: float, lowerLimit: float, upperLimit: float, probabilityOfCollisionMethodName: str, isMaxProbability: bool): ...
    @typing.overload
    def __init__(self, value: float, probabilityOfCollisionMethodName: str): ...
    @typing.overload
    def __init__(self, value: float, probabilityOfCollisionMethodName: str, isMaxProbability: bool): ...
