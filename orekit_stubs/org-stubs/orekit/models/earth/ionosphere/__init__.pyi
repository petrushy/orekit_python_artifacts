...
class IonosphericDelayModel(org.orekit.utils.ParameterDriversProvider):
    ...
    def pathDelay(self, state: org.orekit.propagation.SpacecraftState, baseFrame: org.orekit.frames.TopocentricFrame, receptionDate: org.orekit.time.AbsoluteDate, frequency: float, parameters: typing.Union[typing.List[float], jpype.JArray]) -> float:
        ...
        ...
    @typing.overload
    def pathDelay(self, state: org.orekit.propagation.FieldSpacecraftState[_pathDelay_1__T], baseFrame: org.orekit.frames.TopocentricFrame, receptionDate: org.orekit.time.FieldAbsoluteDate[_pathDelay_1__T], frequency: float, parameters: typing.Union[typing.List[_pathDelay_1__T], jpype.JArray]) -> _pathDelay_1__T:
        """
        Calculates the ionospheric path delay for the signal path from a ground station to a satellite.
...
class IonosphericMappingFunction:
    ...
    def mappingFactor(self, elevation: float) -> float:
        ...
        ...
    @typing.overload
    def mappingFactor(self, elevation: _mappingFactor_1__T) -> _mappingFactor_1__T:
        """
        This method allows the computation of the ionospheric mapping factor.
...
class IonosphericModel(org.orekit.utils.ParameterDriversProvider):
    ...
    def pathDelay(self, state: org.orekit.propagation.SpacecraftState, baseFrame: org.orekit.frames.TopocentricFrame, frequency: float, parameters: typing.Union[typing.List[float], jpype.JArray]) -> float:
        ...
        ...
    @typing.overload
    def pathDelay(self, state: org.orekit.propagation.FieldSpacecraftState[_pathDelay_1__T], baseFrame: org.orekit.frames.TopocentricFrame, frequency: float, parameters: typing.Union[typing.List[_pathDelay_1__T], jpype.JArray]) -> _pathDelay_1__T:
        """
        Calculates the ionospheric path delay for the signal path from a ground station to a satellite.
...
class KlobucharIonoCoefficientsLoader(org.orekit.data.AbstractSelfFeedingLoader, org.orekit.data.DataLoader):
    ...
    They are obtained from CODE. Find more on the files at the `Astronomical Institute site <http://www.aiub.unibe.ch/research/code___analysis_center/klobuchar_style_ionospheric_coefficients/index_eng.html>`.
    ...
    def loadKlobucharIonosphericCoefficients(self, dateComponents: org.orekit.time.DateComponents) -> None:
        ...
        Parameters:
            dateComponents (DateComponents): day given but its DateComponents
...
class EstimatedIonosphericModel(IonosphericModel, IonosphericDelayModel):
    ...
    """
    def __init__(self, model: IonosphericMappingFunction, vtecValue: float):
        """
        Build a new instance.
        
        Parameters:
            model (IonosphericMappingFunction): ionospheric mapping function
            vtecValue (double): value of the Vertical Total Electron Content in TECUnits
...
class GlobalIonosphereMapModel(IonosphericModel, IonosphericDelayModel):
    ...
    IONEX files are obtained from ionex.
...
class KlobucharIonoModel(IonosphericModel, IonosphericDelayModel):
    ...
    def pathDelay(self, spacecraftState: org.orekit.propagation.SpacecraftState, topocentricFrame: org.orekit.frames.TopocentricFrame, double: float, doubleArray: typing.Union[typing.List[float], jpype.JArray]) -> float:
        ...
        Parameters:
            ...
            geo (GeodeticPoint): geodetic point of receiver/station
            elevation (double): elevation of the satellite in radians
    ...
    def pathDelay(self, fieldSpacecraftState: org.orekit.propagation.FieldSpacecraftState[_pathDelay_3__T], topocentricFrame: org.orekit.frames.TopocentricFrame, double: float, tArray: typing.Union[typing.List[_pathDelay_3__T], jpype.JArray]) -> _pathDelay_3__T:
        ...
        Parameters:
            ...
            geo (FieldGeodeticPoint<T> geo): geodetic point of receiver/station
            elevation (T): elevation of the satellite in radians
...
class PythonIonosphericDelayModel(IonosphericDelayModel):
    """
    Python implementation of the IonosphericDelayModel interface. This class is part of the JCC Python interface and exposes all methods natively.
    """
    def __init__(self): ...
...
class PythonIonosphericMappingFunction(IonosphericMappingFunction):
    ...
    def mappingFactor(self, elevation: float) -> float:
        ...
        Specified by: mappingFactor in interface IonosphericMappingFunction
    ...
    def mappingFactor_T(self, elevation: _mappingFactor_T__T) -> _mappingFactor_T__T:
        """
        This method allows the computation of the ionospheric mapping factor.
...
class SsrVtecIonosphericModel(IonosphericModel, IonosphericDelayModel):
    ...
    """
    def __init__(self, vtecMessage: org.orekit.gnss.metric.messages.ssr.subtype.SsrIm201):
        """
        Constructor.
        
        Parameters:
            vtecMessage (SsrIm201): SSR Ionosphere VTEC Spherical Harmonics Message.
...
class __module_protocol__(Protocol):
    ...
    PythonIonosphericDelayModel: typing.Type[PythonIonosphericDelayModel]
