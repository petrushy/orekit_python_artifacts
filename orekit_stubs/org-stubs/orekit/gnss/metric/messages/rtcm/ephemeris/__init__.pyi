...
class RtcmEphemerisData(org.orekit.gnss.metric.messages.rtcm.RtcmData):
    ...
    def getSatelliteID(self) -> int:
        ...
        """
        ...
    def setAccuracyProvider(self, provider: typing.Union[org.orekit.gnss.metric.messages.common.AccuracyProvider, typing.Callable]) -> None:
        """
        Set the accuracy provider of the ephemeris message.
        
        Parameters:
            provider (AccuracyProvider): the provider to set
...
class RtcmEphemerisMessage(org.orekit.gnss.metric.messages.rtcm.RtcmMessage[_RtcmEphemerisMessage__D], typing.Generic[_RtcmEphemerisMessage__D]):
    ...
    Since:
        11.0
    """
    def __init__(self, typeCode: int, rtcmData: _RtcmEphemerisMessage__D):
        """
        Constructor.
        
        Parameters:
            typeCode (int): message number
            rtcmData (RtcmEphemerisMessage): message data
...
class Rtcm1019(RtcmEphemerisMessage['Rtcm1019Data']):
    ...
    Since:
        11.0
    """
    def __init__(self, typeCode: int, rtcm1019Data: 'Rtcm1019Data'):
        """
        Constructor.
        
        Parameters:
            typeCode (int): message number
            rtcm1019Data (Rtcm1019Data): RTCM 1019 message data
...
class Rtcm1019Data(RtcmEphemerisData):
    ...
    def getGpsNavigationMessage(self) -> org.orekit.propagation.analytical.gnss.data.GPSLegacyNavigationMessage:
        ...
        This method uses the getDefault to initialize the time scales used to configure the reference epochs of the navigation message.
    ...
    def getGpsNavigationMessage(self, timeScales: org.orekit.time.TimeScales) -> org.orekit.propagation.analytical.gnss.data.GPSLegacyNavigationMessage:
        ...
        Parameters:
            timeScales (TimeScales): time scales to use for initializing epochs
    ...
    def getGpsToc(self) -> float:
        ...
        """
        ...
    def setGpsCodeOnL2(self, gpsCodeOnL2: int) -> None:
        """
        ...
        """
        ...
    def setGpsFitInterval(self, gpsFitInterval: int) -> None:
        """
        ...
        """
        ...
    def setGpsL2PDataFlag(self, gpsL2PDataFlag: bool) -> None:
        """
        ...
        """
        ...
    def setGpsNavigationMessage(self, gpsNavigationMessage: org.orekit.propagation.analytical.gnss.data.GPSLegacyNavigationMessage) -> None:
        """
        Set the GPS navigation message.
        
        Parameters:
            gpsNavigationMessage (GPSLegacyNavigationMessage): the GPS navigation message to set
        
        
        """
        ...
    def setGpsToc(self, toc: float) -> None:
        """
...
class Rtcm1020(RtcmEphemerisMessage['Rtcm1020Data']):
    ...
    Since:
        11.0
    """
    def __init__(self, typeCode: int, rtcm1020Data: 'Rtcm1020Data'):
        """
        Constructor.
        
        Parameters:
            typeCode (int): message number
            rtcm1020Data (Rtcm1020Data): RTCM 1020 message data
...
class Rtcm1020Data(RtcmEphemerisData):
    ...
    def getFT(self) -> int:
        ...
        It is a parameter that provides the predicted satellite user range accuracy at time getTime.
    ...
    def getP1(self) -> int:
        ...
        Word P1 is a flag of the immediate data updating. It indicates a time interval between two adjacent values of getTime parameter (in seconds).
    ...
    def getP2(self) -> int:
        ...
        Word P2 is flag of oddness ("1") or evenness ("0") of the value of getTime.
    ...
    def isHealthAvailable(self) -> bool:
        ...
        """
        ...
    def setAreAdditionalDataAvailable(self, areAdditionalDataAvailable: bool) -> None:
        """
    ...
    def setBN(self, word: int) -> None:
        ...
        """
        ...
    def setDeltaTN(self, deltaTN: float) -> None:
        """
    ...
    def setGlonassNavigationMessage(self, glonassNavigationMessage: org.orekit.propagation.analytical.gnss.data.GLONASSNavigationMessage) -> None:
        ...
        Parameters:
            glonassNavigationMessage (GLONASSNavigationMessage): the Glonass navigation message to set
        
        
        """
        ...
    def setHealthAvailabilityIndicator(self, healthAvailabilityIndicator: bool) -> None:
        """
        ...
        """
        ...
    def setLNFifthString(self, word: int) -> None:
        """
        ...
        """
        ...
    def setLNThirdString(self, word: int) -> None:
        """
    ...
    def setP4(self, p4: int) -> None:
        ...
        """
        ...
    def setTauC(self, tauC: float) -> None:
        """
        ...
        """
        ...
    def setTauGps(self, tauGps: float) -> None:
        """
...
class Rtcm1042(RtcmEphemerisMessage['Rtcm1042Data']):
    ...
    Since:
        11.0
    """
    def __init__(self, typeCode: int, rtcm1042Data: 'Rtcm1042Data'):
        """
        Constructor.
        
        Parameters:
            typeCode (int): message number
            rtcm1042Data (Rtcm1042Data): RTCM 1042 message data
...
class Rtcm1042Data(RtcmEphemerisData):
    ...
    def getSvHealth(self) -> float:
        ...
        """
        ...
    def setBeidouNavigationMessage(self, beidouNavigationMessage: org.orekit.propagation.analytical.gnss.data.BeidouLegacyNavigationMessage) -> None:
        """
        Set the Beidou navigation message.
        
        Parameters:
            beidouNavigationMessage (BeidouLegacyNavigationMessage): the Beidou navigation message to set
        
        
        """
        ...
    def setBeidouToc(self, toc: float) -> None:
        """
...
class Rtcm1044(RtcmEphemerisMessage['Rtcm1044Data']):
    ...
    Since:
        11.0
    """
    def __init__(self, typeCode: int, rtcm1044Data: 'Rtcm1044Data'):
        """
        Constructor.
        
        Parameters:
            typeCode (int): message number
            rtcm1044Data (Rtcm1044Data): RTCM 1044 message data
...
class Rtcm1044Data(RtcmEphemerisData):
    ...
    def getQzssToc(self) -> float:
        ...
        """
        ...
    def setQzssCodeOnL2(self, qzssCodeOnL2: int) -> None:
        """
        ...
        """
        ...
    def setQzssFitInterval(self, qzssFitInterval: int) -> None:
        """
        ...
        """
        ...
    def setQzssNavigationMessage(self, qzssNavigationMessage: org.orekit.propagation.analytical.gnss.data.QZSSLegacyNavigationMessage) -> None:
        """
        Set the QZSS navigation message.
        
        Parameters:
            qzssNavigationMessage (QZSSLegacyNavigationMessage): the QZSS navigation message to set
        
        
        """
        ...
    def setQzssToc(self, toc: float) -> None:
        """
...
class Rtcm1045(RtcmEphemerisMessage['Rtcm1045Data']):
    ...
    Since:
        11.0
    """
    def __init__(self, typeCode: int, rtcm1045Data: 'Rtcm1045Data'):
        """
        Constructor.
        
        Parameters:
            typeCode (int): message number
            rtcm1045Data (Rtcm1045Data): RTCM 1045 message data
...
class Rtcm1045Data(RtcmEphemerisData):
    ...
    def getGalileoToc(self) -> float:
        ...
        """
        ...
    def setGalileoDataValidityStatus(self, galileoDataValidityStatus: int) -> None:
        """
    ...
    def setGalileoNavigationMessage(self, galileoNavigationMessage: org.orekit.propagation.analytical.gnss.data.GalileoNavigationMessage) -> None:
        ...
        Parameters:
            galileoNavigationMessage (GalileoNavigationMessage): the Galileo navigation message to set
        
        
        """
        ...
    def setGalileoToc(self, toc: float) -> None:
        """
