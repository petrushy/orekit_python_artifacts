...
class SsrIm201(org.orekit.gnss.metric.messages.ssr.SsrMessage['SsrIm201Header', 'SsrIm201Data']):
    ...
    Since:
        11.0
    """
    def __init__(self, typeCode: int, header: 'SsrIm201Header', data: java.util.List['SsrIm201Data']):
        """
        Constructor.
        
        Parameters:
            typeCode (int): message number
            header (SsrIm201Header): message header
            data (List<SsrIm201Data> data): message data
...
class SsrIm201Data(org.orekit.gnss.metric.messages.ssr.SsrData):
    ...
    def getSphericalHarmonicsOrder(self) -> int:
        ...
        """
        ...
    def setCnm(self, cnm: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray]) -> None:
        """
        ...
        """
        ...
    def setHeightIonosphericLayer(self, heightIonosphericLayer: float) -> None:
        """
        ...
        """
        ...
    def setSnm(self, snm: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray]) -> None:
        """
        ...
        """
        ...
    def setSphericalHarmonicsDegree(self, sphericalHarmonicsDegree: int) -> None:
        """
        ...
        """
        ...
    def setSphericalHarmonicsOrder(self, sphericalHarmonicsOrder: int) -> None:
        """
...
class SsrIm201Header(org.orekit.gnss.metric.messages.ssr.SsrHeader):
    ...
    def getVtecQualityIndicator(self) -> float:
        ...
        """
        ...
    def setNumberOfIonosphericLayers(self, numberOfIonosphericLayers: int) -> None:
        """
        ...
        """
        ...
    def setVtecQualityIndicator(self, vtecQualityIndicator: float) -> None:
        """
