...
class SubFrame:
    ...
    """
    @staticmethod
    def checkParity(previous: int, current: int) -> bool:
        """
        Check parity.
    ...
    def parse(encodedMessage: typing.Union[org.orekit.gnss.metric.parser.EncodedMessage, typing.Callable]) -> 'SubFrame':
        ...
        Parameters:
            encodedMessage (EncodedMessage): encoded message containing exactly one sub-frame
        ...
        Also see:
            SubFrame1, SubFrame2,
            SubFrame3, SubFrame4A0,
            SubFrame4A1, SubFrame4B,
            SubFrame4C, SubFrame4D,
            SubFrame4E, SubFrameAlmanac,
...
class SubFrame1(SubFrame):
    ...
    Table 20-1, sheet 1 and table 40-1, sheet 1 in IS, IS-GPS-200N, 22 Aug 2022
...
class SubFrame2(SubFrame):
    ...
    Table 20-1, sheet 2 and table 40-1, sheet 2 in IS, IS-GPS-200N, 22 Aug 2022
...
class SubFrame3(SubFrame):
    ...
    Table 20-1, sheet 3 and table 40-1, sheet 3 in IS, IS-GPS-200N, 22 Aug 2022
...
class SubFrame4A(SubFrame45):
    """
    Container for sub-frames 4, pages 1, 6, 11, 16 and 21, but also for sub-frames 4, pages 2, 3, 4, 5, 7, 8, and 9 which have a similar structure.
    
    Table 40-1, sheets 6 and 7 in IS, IS-GPS-200N, 22 Aug 2022
...
class SubFrame4B(SubFrame45):
    ...
    Table 40-1, sheet 11 in IS, IS-GPS-200N, 22 Aug 2022
...
class SubFrame4C(SubFrame45):
    ...
    Table 40-1, sheet 10 in IS, IS-GPS-200N, 22 Aug 2022
    ...
    """
    def getERD(self, index: int) -> int:
        """
        Get an Estimated Range Deviation.
        
        Parameters:
            index (int): index of the ERD (between 1 and NB_ERD)
...
class SubFrame4D(SubFrame45):
    ...
    Table 40-1, sheet 8 in IS, IS-GPS-200N, 22 Aug 2022
...
class SubFrame4E(SubFrame45):
    ...
    Table 20-1, sheet 9 and table 40-1, sheet 9 in IS, IS-GPS-200N, 22 Aug 2022
    ...
    def getAntiSpoofing(self) -> int: ...
    @typing.overload
    def getAntiSpoofing(self, index: int) -> int:
        """
    ...
    def getReserved8(self) -> int:
        ...
        """
        ...
    def getSvHealth(self, index: int) -> int:
        """
        Get the Sv health for a satellite.
        
        Parameters:
            index (int): in the sub-frame (from 1 to 7 or 1 to 8 depending on getDataId, beware it
                is not the satellite number, it is also related to getDataId), an
...
class SubFrame5B(SubFrame45):
    ...
    Table 20-1, sheet 5 and table 40-1, sheet 5 in IS, IS-GPS-200N, 22 Aug 2022
...
class SubFrameAlmanac(SubFrame45):
    ...
    Table 20-1, sheet 4 and table 40-1, sheet 4 in IS, IS-GPS-200N, 22 Aug 2022
...
class SubFrameDummyAlmanac(SubFrame45):
    ...
    Section 20.3.3.5.1.2 Almanac Data in IS, IS-GPS-200N, 22 Aug 2022
...
class SubFrame4A0(SubFrame4A):
    ...
    Table 40-1, sheet 6 in IS, IS-GPS-200N, 22 Aug 2022
...
class SubFrame4A1(SubFrame4A):
    ...
    Table 40-1, sheet 7 in IS, IS-GPS-200N, 22 Aug 2022
