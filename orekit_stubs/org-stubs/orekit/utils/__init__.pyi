...
class TimeSpanMap(typing.Generic[_TimeSpanMap__T]):
    ...
    def addValidAfter(self, t: _TimeSpanMap__T, absoluteDate: org.orekit.time.AbsoluteDate) -> None:
        """
            ...
            The transition dates should be entered only once, either by a call to this method or by a call to
            :meth:`~org.orekit.utils.TimeSpanMap.addValidBefore`. Repeating a transition date will lead to unexpected result and is
            not supported.
    ...
    def addValidBefore(self, t: _TimeSpanMap__T, absoluteDate: org.orekit.time.AbsoluteDate) -> None:
        """
            ...
            The transition dates should be entered only once, either by a call to this method or by a call to
            :meth:`~org.orekit.utils.TimeSpanMap.addValidAfter`. Repeating a transition date will lead to unexpected result and is
            not supported.
...
class TimeStampedAngularCoordinates(AngularCoordinates, org.orekit.time.TimeStamped):
    ...
    def getDate(self) -> org.orekit.time.AbsoluteDate:
        ...
        ...
    @staticmethod
    def interpolate(absoluteDate: org.orekit.time.AbsoluteDate, angularDerivativesFilter: AngularDerivativesFilter, collection: typing.Union[java.util.Collection['TimeStampedAngularCoordinates'], typing.Sequence['TimeStampedAngularCoordinates']]) -> 'TimeStampedAngularCoordinates': ...
...
class TimeStampedFieldAngularCoordinates(FieldAngularCoordinates[_TimeStampedFieldAngularCoordinates__T], org.orekit.time.FieldTimeStamped[_TimeStampedFieldAngularCoordinates__T], typing.Generic[_TimeStampedFieldAngularCoordinates__T]):
    ...
    @typing.overload
    @staticmethod
    def interpolate(absoluteDate: org.orekit.time.AbsoluteDate, angularDerivativesFilter: AngularDerivativesFilter, collection: typing.Union[java.util.Collection['TimeStampedFieldAngularCoordinates'[_interpolate_0__T]], typing.Sequence['TimeStampedFieldAngularCoordinates'[_interpolate_0__T]]]) -> 'TimeStampedFieldAngularCoordinates'[_interpolate_0__T]: ...
    @typing.overload
    @staticmethod
    def interpolate(fieldAbsoluteDate: org.orekit.time.FieldAbsoluteDate[_interpolate_1__T], angularDerivativesFilter: AngularDerivativesFilter, collection: typing.Union[java.util.Collection['TimeStampedFieldAngularCoordinates'[_interpolate_1__T]], typing.Sequence['TimeStampedFieldAngularCoordinates'[_interpolate_1__T]]]) -> 'TimeStampedFieldAngularCoordinates'[_interpolate_1__T]: ...
...
class TimeStampedPVCoordinates(PVCoordinates, org.orekit.time.TimeStamped):
    ...
    @typing.overload
    @staticmethod
    def interpolate(absoluteDate: org.orekit.time.AbsoluteDate, cartesianDerivativesFilter: CartesianDerivativesFilter, collection: typing.Union[java.util.Collection['TimeStampedPVCoordinates'], typing.Sequence['TimeStampedPVCoordinates']]) -> 'TimeStampedPVCoordinates': ...
    @typing.overload
    @staticmethod
...
class FieldAbsolutePVCoordinates(TimeStampedFieldPVCoordinates[_FieldAbsolutePVCoordinates__T], org.orekit.time.FieldTimeStamped[_FieldAbsolutePVCoordinates__T], org.orekit.time.FieldTimeInterpolable['FieldAbsolutePVCoordinates'[_FieldAbsolutePVCoordinates__T], _FieldAbsolutePVCoordinates__T], FieldPVCoordinatesProvider[_FieldAbsolutePVCoordinates__T], typing.Generic[_FieldAbsolutePVCoordinates__T]):
    ...
    @typing.overload
    def interpolate(self, fieldAbsoluteDate: org.orekit.time.FieldAbsoluteDate[org.hipparchus.CalculusFieldElement], collection: typing.Union[java.util.Collection[_FieldAbsolutePVCoordinates__T], typing.Sequence[_FieldAbsolutePVCoordinates__T]]) -> _FieldAbsolutePVCoordinates__T: ...
    @typing.overload
    ...
    @typing.overload
    @staticmethod
    def interpolate(fieldAbsoluteDate: org.orekit.time.FieldAbsoluteDate[_interpolate_3__T], cartesianDerivativesFilter: CartesianDerivativesFilter, collection: typing.Union[java.util.Collection[TimeStampedFieldPVCoordinates[_interpolate_3__T]], typing.Sequence[TimeStampedFieldPVCoordinates[_interpolate_3__T]]]) -> TimeStampedFieldPVCoordinates[_interpolate_3__T]: ...
    @typing.overload
    @staticmethod
