...
class Unit(java.io.Serializable):
    ...
    def parse(string: str) -> 'Unit':
        """
            ...
            arcminute
              The base symbol for is "′" (U+2032, PRIME) but we also accept "'" (U+0027, APOSTROPHE)
        
            arcsecond
              The base symbol for is "″" (U+2033, DOUBLE PRIME) but we also accept "''" (two occurrences of U+0027, APOSTROPHE),
