...
class FieldGnssPropagatorBuilder(typing.Generic[_FieldGnssPropagatorBuilder__T]):
    ...
    """
    @typing.overload
    def __init__(self, orbitalElements: org.orekit.propagation.analytical.gnss.data.FieldGnssOrbitalElements[_FieldGnssPropagatorBuilder__T, typing.Any]): ...
    @typing.overload
    def __init__(self, orbitalElements: org.orekit.propagation.analytical.gnss.data.FieldGnssOrbitalElements[_FieldGnssPropagatorBuilder__T, typing.Any], frames: org.orekit.frames.Frames): ...
...
class GLONASSAnalyticalPropagatorBuilder:
    ...
    """
    @typing.overload
    def __init__(self, glonassOrbElt: typing.Union[org.orekit.propagation.analytical.gnss.data.GLONASSOrbitalElements, typing.Callable]): ...
    @typing.overload
    def __init__(self, glonassOrbElt: typing.Union[org.orekit.propagation.analytical.gnss.data.GLONASSOrbitalElements, typing.Callable], dataContext: org.orekit.data.DataContext): ...
...
class GNSSPropagatorBuilder:
    ...
    """
    @typing.overload
    def __init__(self, orbitalElements: org.orekit.propagation.analytical.gnss.data.GNSSOrbitalElements[typing.Any]): ...
    @typing.overload
    def __init__(self, orbitalElements: org.orekit.propagation.analytical.gnss.data.GNSSOrbitalElements[typing.Any], frames: org.orekit.frames.Frames): ...
...
class SBASPropagatorBuilder:
    ...
    """
    @typing.overload
    def __init__(self, sbasOrbElt: org.orekit.propagation.analytical.gnss.data.SBASOrbitalElements): ...
    @typing.overload
    def __init__(self, sbasOrbElt: org.orekit.propagation.analytical.gnss.data.SBASOrbitalElements, frames: org.orekit.frames.Frames): ...
