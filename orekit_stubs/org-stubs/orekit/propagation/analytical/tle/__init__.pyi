...
class FieldTLE(org.orekit.time.FieldTimeStamped[_FieldTLE__T], org.orekit.utils.ParameterDriversProvider, typing.Generic[_FieldTLE__T]):
    ...
    """
    @typing.overload
    def __init__(self, satelliteNumber: int, classification: str, launchYear: int, launchNumber: int, launchPiece: str, ephemerisType: int, elementNumber: int, epoch: org.orekit.time.FieldAbsoluteDate[_FieldTLE__T], meanMotion: _FieldTLE__T, meanMotionFirstDerivative: _FieldTLE__T, meanMotionSecondDerivative: _FieldTLE__T, e: _FieldTLE__T, i: _FieldTLE__T, pa: _FieldTLE__T, raan: _FieldTLE__T, meanAnomaly: _FieldTLE__T, revolutionNumberAtEpoch: int, bStar: float): ...
    @typing.overload
    def __init__(self, satelliteNumber: int, classification: str, launchYear: int, launchNumber: int, launchPiece: str, ephemerisType: int, elementNumber: int, epoch: org.orekit.time.FieldAbsoluteDate[_FieldTLE__T], meanMotion: _FieldTLE__T, meanMotionFirstDerivative: _FieldTLE__T, meanMotionSecondDerivative: _FieldTLE__T, e: _FieldTLE__T, i: _FieldTLE__T, pa: _FieldTLE__T, raan: _FieldTLE__T, meanAnomaly: _FieldTLE__T, revolutionNumberAtEpoch: int, bStar: float, utc: org.orekit.time.TimeScale): ...
    @typing.overload
    def __init__(self, field: org.hipparchus.Field[_FieldTLE__T], line1: str, line2: str): ...
    @typing.overload
    def __init__(self, field: org.hipparchus.Field[_FieldTLE__T], line1: str, line2: str, utc: org.orekit.time.TimeScale): ...
    ...
    @typing.overload
    @staticmethod
    def stateToTLE(state: org.orekit.propagation.FieldSpacecraftState[_stateToTLE_2__T], templateTLE: 'FieldTLE'[_stateToTLE_2__T], converter: org.orekit.propagation.conversion.osc2mean.OsculatingToMeanConverter, dataContext: org.orekit.data.DataContext) -> 'FieldTLE'[_stateToTLE_2__T]: ...
...
class FieldTLEPropagator(org.orekit.propagation.analytical.FieldAbstractAnalyticalPropagator[_FieldTLEPropagator__T], typing.Generic[_FieldTLEPropagator__T]):
    ...
    def getMU() -> float:
        ...
        ...
    @typing.overload
    def getPVCoordinates(self, date: org.orekit.time.FieldAbsoluteDate[_FieldTLEPropagator__T], parameters: org.orekit.frames.Frame) -> org.orekit.utils.TimeStampedFieldPVCoordinates[_FieldTLEPropagator__T]: ...
    @typing.overload
    def getPVCoordinates(self, date: org.orekit.time.FieldAbsoluteDate[_FieldTLEPropagator__T], parameters: typing.Union[typing.List[_FieldTLEPropagator__T], jpype.JArray]) -> org.orekit.utils.FieldPVCoordinates[_FieldTLEPropagator__T]: ...
    def getParametersDrivers(self) -> java.util.List[org.orekit.utils.ParameterDriver]:
        """
        Get the drivers for parameters.
    ...
    @typing.overload
    @staticmethod
    def selectExtrapolator(tle: FieldTLE[_selectExtrapolator_0__T], parameters: typing.Union[typing.List[_selectExtrapolator_0__T], jpype.JArray]) -> 'FieldTLEPropagator'[_selectExtrapolator_0__T]:
        """
    ...
    @typing.overload
    @staticmethod
    def selectExtrapolator(tle: FieldTLE[_selectExtrapolator_1__T], attitudeProvider: org.orekit.attitudes.AttitudeProvider, mass: _selectExtrapolator_1__T, parameters: typing.Union[typing.List[_selectExtrapolator_1__T], jpype.JArray]) -> 'FieldTLEPropagator'[_selectExtrapolator_1__T]: ...
    @typing.overload
    @staticmethod
    def selectExtrapolator(tle: FieldTLE[_selectExtrapolator_2__T], attitudeProvider: org.orekit.attitudes.AttitudeProvider, mass: _selectExtrapolator_2__T, teme: org.orekit.frames.Frame, parameters: typing.Union[typing.List[_selectExtrapolator_2__T], jpype.JArray]) -> 'FieldTLEPropagator'[_selectExtrapolator_2__T]: ...
    @typing.overload
    @staticmethod
    def selectExtrapolator(tle: FieldTLE[_selectExtrapolator_3__T], teme: org.orekit.frames.Frame, parameters: typing.Union[typing.List[_selectExtrapolator_3__T], jpype.JArray]) -> 'FieldTLEPropagator'[_selectExtrapolator_3__T]: ...
...
class TLE(org.orekit.time.TimeStamped, org.orekit.utils.ParameterDriversProvider):
    ...
    """
    @typing.overload
    def __init__(self, satelliteNumber: int, classification: str, launchYear: int, launchNumber: int, launchPiece: str, ephemerisType: int, elementNumber: int, epoch: org.orekit.time.AbsoluteDate, meanMotion: float, meanMotionFirstDerivative: float, meanMotionSecondDerivative: float, e: float, i: float, pa: float, raan: float, meanAnomaly: float, revolutionNumberAtEpoch: int, bStar: float): ...
    @typing.overload
    def __init__(self, satelliteNumber: int, classification: str, launchYear: int, launchNumber: int, launchPiece: str, ephemerisType: int, elementNumber: int, epoch: org.orekit.time.AbsoluteDate, meanMotion: float, meanMotionFirstDerivative: float, meanMotionSecondDerivative: float, e: float, i: float, pa: float, raan: float, meanAnomaly: float, revolutionNumberAtEpoch: int, bStar: float, utc: org.orekit.time.TimeScale): ...
    @typing.overload
    def __init__(self, line1: str, line2: str): ...
    @typing.overload
    def __init__(self, line1: str, line2: str, utc: org.orekit.time.TimeScale): ...
    ...
    @typing.overload
    @staticmethod
    def stateToTLE(state: org.orekit.propagation.SpacecraftState, templateTLE: 'TLE', converter: org.orekit.propagation.conversion.osc2mean.OsculatingToMeanConverter, dataContext: org.orekit.data.DataContext) -> 'TLE': ...
    def toString(self) -> str:
        """
        Get a string representation of this TLE set.
...
class TLEPropagator(org.orekit.propagation.analytical.AbstractAnalyticalPropagator):
    ...
    @typing.overload
    @staticmethod
    def selectExtrapolator(tle: TLE, attitudeProvider: org.orekit.attitudes.AttitudeProvider, mass: float, teme: org.orekit.frames.Frame) -> 'TLEPropagator': ...
    @typing.overload
    @staticmethod
    def selectExtrapolator(tle: TLE, teme: org.orekit.frames.Frame) -> 'TLEPropagator': ...
    @typing.overload
    @staticmethod
...
class FieldSGP4(FieldTLEPropagator[_FieldSGP4__T], typing.Generic[_FieldSGP4__T]):
    ...
    """
    @typing.overload
    def __init__(self, initialTLE: FieldTLE[_FieldSGP4__T], attitudeProvider: org.orekit.attitudes.AttitudeProvider, mass: _FieldSGP4__T, parameters: typing.Union[typing.List[_FieldSGP4__T], jpype.JArray]): ...
    @typing.overload
    def __init__(self, initialTLE: FieldTLE[_FieldSGP4__T], attitudeProvider: org.orekit.attitudes.AttitudeProvider, mass: _FieldSGP4__T, teme: org.orekit.frames.Frame, parameters: typing.Union[typing.List[_FieldSGP4__T], jpype.JArray]): ...

class PythonTLEPropagator(TLEPropagator):
    @typing.overload
    def __init__(self, initialTLE: TLE, attitudeProvider: org.orekit.attitudes.AttitudeProvider, mass: float): ...
    @typing.overload
    def __init__(self, initialTLE: TLE, attitudeProvider: org.orekit.attitudes.AttitudeProvider, mass: float, teme: org.orekit.frames.Frame): ...
...
class FieldDeepSDP4(org.orekit.propagation.analytical.tle.FieldSDP4[_FieldDeepSDP4__T], typing.Generic[_FieldDeepSDP4__T]):
    ...
    """
    @typing.overload
    def __init__(self, initialTLE: FieldTLE[_FieldDeepSDP4__T], attitudeProvider: org.orekit.attitudes.AttitudeProvider, mass: _FieldDeepSDP4__T, parameters: typing.Union[typing.List[_FieldDeepSDP4__T], jpype.JArray]): ...
    @typing.overload
    def __init__(self, initialTLE: FieldTLE[_FieldDeepSDP4__T], attitudeProvider: org.orekit.attitudes.AttitudeProvider, mass: _FieldDeepSDP4__T, teme: org.orekit.frames.Frame, parameters: typing.Union[typing.List[_FieldDeepSDP4__T], jpype.JArray]): ...
