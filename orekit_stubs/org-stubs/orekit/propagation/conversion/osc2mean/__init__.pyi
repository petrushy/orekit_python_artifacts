...
class BrouwerLyddaneTheory(MeanTheory):
    ...
    """
    @typing.overload
    def __init__(self, referenceRadius: float, mu: float, c20: float, c30: float, c40: float, c50: float, m2Value: float): ...
    @typing.overload
    def __init__(self, provider: org.orekit.forces.gravity.potential.UnnormalizedSphericalHarmonicsProvider, m2Value: float): ...
    def getReferenceRadius(self) -> float:
        """
        Gets reference radius of the central body (m).
...
class DSSTTheory(MeanTheory):
    ...
    """
    @typing.overload
    def __init__(self, forceModels: typing.Union[java.util.Collection[org.orekit.propagation.semianalytical.dsst.forces.DSSTForceModel], typing.Sequence[org.orekit.propagation.semianalytical.dsst.forces.DSSTForceModel], typing.Set[org.orekit.propagation.semianalytical.dsst.forces.DSSTForceModel]]): ...
    @typing.overload
    def __init__(self, forceModels: typing.Union[java.util.Collection[org.orekit.propagation.semianalytical.dsst.forces.DSSTForceModel], typing.Sequence[org.orekit.propagation.semianalytical.dsst.forces.DSSTForceModel], typing.Set[org.orekit.propagation.semianalytical.dsst.forces.DSSTForceModel]], attitudeProvider: org.orekit.attitudes.AttitudeProvider, mass: float): ...
    def getReferenceRadius(self) -> float:
        """
        Gets reference radius of the central body (m).
...
class EcksteinHechlerTheory(MeanTheory):
    ...
    """
    @typing.overload
    def __init__(self, referenceRadius: float, mu: float, c20: float, c30: float, c40: float, c50: float, c60: float): ...
    @typing.overload
...
class FixedPointConverter(OsculatingToMeanConverter):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, threshold: float, maxIterations: int, damping: float): ...
    @typing.overload
    def __init__(self, theory: MeanTheory): ...
    @typing.overload
    def __init__(self, theory: MeanTheory, threshold: float, maxIterations: int, damping: float): ...
    _convertToMean_0__T = typing.TypeVar('_convertToMean_0__T', bound=org.hipparchus.CalculusFieldElement)  # <T>
    @typing.overload
    def convertToMean(self, osculating: org.orekit.orbits.FieldOrbit[_convertToMean_0__T]) -> org.orekit.orbits.FieldOrbit[_convertToMean_0__T]:
        """
...
class LeastSquaresConverter(OsculatingToMeanConverter):
    ...
    @typing.overload
    def __init__(self, theory: MeanTheory, optimizer: typing.Union[org.hipparchus.optim.nonlinear.vector.leastsquares.LeastSquaresOptimizer, typing.Callable], threshold: float, maxIterations: int): ...
    _convertToMean_0__T = typing.TypeVar('_convertToMean_0__T', bound=org.hipparchus.CalculusFieldElement)  # <T>
    @typing.overload
    def convertToMean(self, osculating: org.orekit.orbits.FieldOrbit[_convertToMean_0__T]) -> org.orekit.orbits.FieldOrbit[_convertToMean_0__T]:
        """
...
class TLETheory(MeanTheory):
    ...
    @typing.overload
    def __init__(self, template: org.orekit.propagation.analytical.tle.FieldTLE[___init___4__T], utc: org.orekit.time.TimeScale, teme: org.orekit.frames.Frame): ...
    @typing.overload
    ...
    @typing.overload
    def __init__(self, template: org.orekit.propagation.analytical.tle.TLE, utc: org.orekit.time.TimeScale, teme: org.orekit.frames.Frame): ...
    @typing.overload
