...
class OsculatingToBrouwerLyddaneConverter(FixedPointOsculatingToAveragedConverter[org.orekit.propagation.conversion.averaging.BrouwerLyddaneOrbitalState]):
    ...
    """
    @typing.overload
    def __init__(self, epsilon: float, maxIterations: int, harmonicsProvider: org.orekit.forces.gravity.potential.UnnormalizedSphericalHarmonicsProvider): ...
    @typing.overload
    def __init__(self, harmonicsProvider: org.orekit.forces.gravity.potential.UnnormalizedSphericalHarmonicsProvider): ...
...
class OsculatingToSGP4Converter(FixedPointOsculatingToAveragedConverter[org.orekit.propagation.conversion.averaging.SGP4OrbitalState]):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, epsilon: float, maxIterations: int, scale: float, dataContext: org.orekit.data.DataContext): ...
    @typing.overload
