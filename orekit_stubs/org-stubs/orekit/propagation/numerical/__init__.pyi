...
class EpochDerivativesEquations(org.orekit.propagation.integration.AdditionalEquations):
    """
    public class EpochDerivativesEquations extends :class:`~org.orekit.propagation.numerical.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object?is` implements :class:`~org.orekit.propagation.integration.AdditionalEquations`
    
        This class is a copy of :class:`~org.orekit.propagation.numerical.AbsolutePartialDerivativesEquations` The computation
        of the derivatives of the acceleration due to a ThirdBodyAttraction has been added. Set of
        :class:`~org.orekit.propagation.integration.AdditionalEquations` computing the partial derivatives of the state (orbit)
        with respect to initial state and force models parameters.
...
class NumericalPropagator(org.orekit.propagation.integration.AbstractIntegratedPropagator):
    ...
    public class NumericalPropagator extends :class:`~org.orekit.propagation.integration.AbstractIntegratedPropagator`
        ...
        The configuration parameters that can be set are:
          ...
          - whether :class:`~org.orekit.propagation.integration.AdditionalEquations` (for example
            :class:`~org.orekit.propagation.numerical.PartialDerivativesEquations`) should be propagated along with orbital state
            (:meth:`~org.orekit.propagation.integration.AbstractIntegratedPropagator.addAdditionalEquations`),
          - the discrete events that should be triggered during propagation
...
class PartialDerivativesEquations(org.orekit.propagation.integration.AdditionalEquations):
    """
    public class PartialDerivativesEquations extends :class:`~org.orekit.propagation.numerical.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object?is` implements :class:`~org.orekit.propagation.integration.AdditionalEquations`
...
class AbsolutePartialDerivativesEquations(PartialDerivativesEquations):
    """
    public class AbsolutePartialDerivativesEquations extends :class:`~org.orekit.propagation.numerical.PartialDerivativesEquations`
