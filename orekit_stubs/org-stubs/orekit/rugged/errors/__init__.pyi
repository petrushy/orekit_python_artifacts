...
class DumpManager:
    ...
    @typing.overload
    @staticmethod
    def dumpAlgorithm(algorithmId: org.orekit.rugged.api.AlgorithmId, specific: float) -> None: ...
    @staticmethod
...
class RuggedException(java.lang.RuntimeException, org.hipparchus.exception.LocalizedException):
    ...
    """
    @typing.overload
    def __init__(self, cause: java.lang.Throwable, specifier: org.hipparchus.exception.Localizable, *parts: typing.Any): ...
    @typing.overload
    def __init__(self, specifier: org.hipparchus.exception.Localizable, *parts: typing.Any): ...
