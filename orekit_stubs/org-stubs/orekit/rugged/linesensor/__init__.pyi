...
class LinearLineDatation(LineDatation):
    """
    public class LinearLineDatation extends Object implements :class:`~org.orekit.rugged.linesensor.LineDatation`
    ...
    def getDate(self, double: float) -> org.orekit.time.AbsoluteDate:
        """
            ...
            Specified by:
                :meth:`~org.orekit.rugged.linesensor.LineDatation.getDate`Â in
                interfaceÂ :class:`~org.orekit.rugged.linesensor.LineDatation`
    ...
    def getLine(self, absoluteDate: org.orekit.time.AbsoluteDate) -> float:
        """
            ...
            Specified by:
                :meth:`~org.orekit.rugged.linesensor.LineDatation.getLine`Â in
                interfaceÂ :class:`~org.orekit.rugged.linesensor.LineDatation`
    ...
    def getRate(self, double: float) -> float:
        """
            ...
            Specified by:
                :meth:`~org.orekit.rugged.linesensor.LineDatation.getRate`Â in
                interfaceÂ :class:`~org.orekit.rugged.linesensor.LineDatation`
