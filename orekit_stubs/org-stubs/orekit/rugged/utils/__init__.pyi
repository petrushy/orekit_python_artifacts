...
class AbsoluteDateArrayHandling:
    def __init__(self, absoluteDateArray: typing.List[org.orekit.time.AbsoluteDate]): ...
    def durationFrom(self, absoluteDateArray: typing.List[org.orekit.time.AbsoluteDate]) -> typing.List[float]: ...
    def getDates(self) -> typing.List[org.orekit.time.AbsoluteDate]: ...
    def multipleDurationFrom(self, absoluteDateArray: typing.List[org.orekit.time.AbsoluteDate]) -> typing.List[typing.List[float]]: ...
    def multipleShiftedBy(self, doubleArray: typing.List[float]) -> typing.List[typing.List[org.orekit.time.AbsoluteDate]]: ...
    def shiftedBy(self, doubleArray: typing.List[float]) -> typing.List[org.orekit.time.AbsoluteDate]: ...
