...
class ExtendedEllipsoid(org.orekit.bodies.OneAxisEllipsoid):
    ...
    def __init__(self, ae: float, f: float, bodyFrame: org.orekit.frames.Frame):
        ...
        ...
    @typing.overload
    def convertLos(self, point: org.hipparchus.geometry.euclidean.threed.Vector3D, los: org.hipparchus.geometry.euclidean.threed.Vector3D) -> org.hipparchus.geometry.euclidean.threed.Vector3D:
        """
    ...
    @typing.overload
    def transform(self, point: org.orekit.utils.PVCoordinates, frame: org.orekit.frames.Frame, date: org.orekit.time.AbsoluteDate) -> org.orekit.bodies.FieldGeodeticPoint[org.hipparchus.analysis.differentiation.UnivariateDerivative2]: ...
    @typing.overload
    ...
    @typing.overload
    def transform(self, point: org.hipparchus.geometry.euclidean.threed.Vector3D, frame: org.orekit.frames.Frame, date: org.orekit.time.AbsoluteDate, centralLongitude: float) -> 'NormalizedGeodeticPoint': ...
...
class SpacecraftToObservedBody(java.io.Serializable):
    ...
    """
    @typing.overload
    def __init__(self, inertialFrame: org.orekit.frames.Frame, bodyFrame: org.orekit.frames.Frame, minDate: org.orekit.time.AbsoluteDate, maxDate: org.orekit.time.AbsoluteDate, tStep: float, overshootTolerance: float, positionsVelocities: java.util.List[org.orekit.utils.TimeStampedPVCoordinates], pvInterpolationNumber: int, pvFilter: org.orekit.utils.CartesianDerivativesFilter, quaternions: java.util.List[org.orekit.utils.TimeStampedAngularCoordinates], aInterpolationNumber: int, aFilter: org.orekit.utils.AngularDerivativesFilter): ...
    @typing.overload
    def __init__(self, inertialFrame: org.orekit.frames.Frame, bodyFrame: org.orekit.frames.Frame, minDate: org.orekit.time.AbsoluteDate, maxDate: org.orekit.time.AbsoluteDate, tStep: float, overshootTolerance: float, bodyToInertial: java.util.List[org.orekit.frames.Transform], scToInertial: java.util.List[org.orekit.frames.Transform]): ...
